...
CNSReact::variableSetUp ()
{
    ...
    desc_lst.setComponent(State_Type,
                          ...
                          name,
                          bcs,
                          BndryFunc(BL_FORT_PROC_CALL(CNS_DENFILL,cns_denfill),
                                    BL_FORT_PROC_CALL(CNS_HYPFILL,cns_hypfill)));
    ...
    derive_lst.add("pressure",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERPRES,cns_derpres),the_same_box);
    ...
    derive_lst.add("kineng",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERKINENG,cns_derkineng),the_same_box);
    ...
    derive_lst.add("soundspeed",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERSOUNDSPEED,cns_dersoundspeed),the_same_box);
    ...
    derive_lst.add("MachNumber",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERMACHNUMBER,cns_dermachnumber),the_same_box);
    ...
    derive_lst.add("magvort",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERMAGVORT,cns_dermagvort),grow_box_by_one);
    ...
    derive_lst.add("divu",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERDIVU,cns_derdivu),grow_box_by_one);
    ...
    derive_lst.add("eint_E",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DEREINT1,cns_dereint1),the_same_box);
    ...
    //
    derive_lst.add("eint_e",IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DEREINT2,cns_dereint2),the_same_box);
    derive_lst.addComponent("eint_e",desc_lst,State_Type,Density,NUM_STATE);
    ...
    for (int i = 0; i < NumSpec; i++)
    {
        ...
        derive_lst.add(name,IndexType::TheCellType(),1,
                   BL_FORT_PROC_CALL(CNS_DERSPEC,cns_derspec),the_same_box);
    ...
    derive_lst.add("molefrac",IndexType::TheCellType(),NumSpec, var_names_molefrac,
                   BL_FORT_PROC_CALL(CNS_DERMOLEFRAC,cns_dermolefrac),the_same_box);
    ...
    //                BL_FORT_PROC_CALL(CNS_DERCONCENTRATION,cns_derconcentration),the_same_box);
    ...
    derive_lst.add("x_velocity",IndexType::TheCellType(),1,
          BL_FORT_PROC_CALL(CNS_DERVEL,cns_dervel),the_same_box);
    ...
    derive_lst.add("magvel",IndexType::TheCellType(),1,
          BL_FORT_PROC_CALL(CNS_DERMAGVEL,cns_dermagvel),the_same_box);
    ...
    derive_lst.add("magmom",IndexType::TheCellType(),1,
          BL_FORT_PROC_CALL(CNS_DERMAGMOM,cns_dermagmom),the_same_box);
