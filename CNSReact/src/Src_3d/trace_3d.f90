...
contains
      ...
      integer,intent(in):: dq_l1,dq_l2,dq_l3,dq_h1,dq_h2,dq_h3
      ...
      double precision,intent(in):: dqx(dq_l1:dq_h1,dq_l2:dq_h2,dq_l3:dq_h3,QVAR)
      double precision,intent(in):: dqy(dq_l1:dq_h1,dq_l2:dq_h2,dq_l3:dq_h3,QVAR)
...
! ::: 
      ...
      double precision,intent(out):: dqz(dq_l1:dq_h1,dq_l2:dq_h2,dq_l3:dq_h3,QVAR)
