...
! ::: -----------------------------------------------------------
      subroutine cns_laplac_error(tag,tagl1,tagl2,tagl3,tagh1,tagh2,tagh3, &
                                 set,clear, &
      ...
      end subroutine cns_laplac_error
...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine cns_denerror(tag,tagl1,tagl2,tagl3,tagh1,tagh2,tagh3, &
                             set,clear, &
...
! ::: -----------------------------------------------------------
      ...
      subroutine cns_temperror(tag,tagl1,tagl2,tagl3,tagh1,tagh2,tagh3, &
                              set,clear, &
...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine cns_presserror(tag,tagl1,tagl2,tagl3,tagh1,tagh2,tagh3, &
                             set,clear, &
...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine cns_velerror(tag,tagl1,tagl2,tagl3,tagh1,tagh2,tagh3, &
                             set,clear, &
