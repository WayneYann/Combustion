...
subroutine PROBINIT (init,name,namlen,problo,probhi)
  ...
  namelist /fortin/ zstandoff, pertmag, pAmb, probtype, &
...
subroutine cns_initdata(level,time,lo,hi,nscal, &
  ...
  double precision, intent(in) :: xlo(3), xhi(3), time, delta(3)
  double precision, intent(out) :: state(state_l1:state_h1,state_l2:state_h2, &
     ...
     do j = lo(2), hi(2)
        ...
        do i = lo(1), hi(1)
           ...
           if(probtype .eq. 1 )then
              ...
              z1 = (zcen-0.d50*delta(3)+zstandoff+pert + 3.011d0)
              z2 = (zcen+0.d50*delta(3)+zstandoff+pert + 3.011d0)
...
! ::: -----------------------------------------------------------
subroutine cns_hypfill(adv,adv_l1,adv_l2,adv_l3, &
     &                    adv_h1,adv_h2,adv_h3, &
...
subroutine cns_denfill(adv,adv_l1,adv_l2,adv_l3, &
     &                    adv_h1,adv_h2,adv_h3, &
     domlo,domhi,delta,xlo,time,bc)
