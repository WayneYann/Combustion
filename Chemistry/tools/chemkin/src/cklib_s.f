...
C                                                                      C
C*****precision > double
C      DOUBLE PRECISION FUNCTION CKATOM(ENAME)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C*****END precision > double
C*****precision > single
...
C                                                                      C
C*****precision > double
C      DOUBLE PRECISION FUNCTION CKBSEC (NPTS, X, XX, TT)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C*****END precision > double
C*****precision > single
...
C*****precision > double
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (AVAG = 6.022D23)
C*****END precision > double
C*****precision > single
      IMPLICIT REAL (A-H, O-Z), INTEGER (I-N)
      PARAMETER (AVAG = 6.022E23)
C*****END precision > single
C
      INCLUDE 'ckstrt.h'
      COMMON /MACH/ SMALL,BIG,EXPARG
...
C*****precision > double
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (AVAG = 6.022D23, ECHRG=1.6022D-12, SMALLX=1.D-50)
C*****END precision > double
C*****precision > single
      IMPLICIT REAL (A-H, O-Z), INTEGER (I-N)
      PARAMETER (AVAG = 6.022E23, ECHRG=1.6022E-12, SMALLX = 1.E-30)
C*****END precision > single
C
      INCLUDE 'ckstrt.h'
      COMMON /MACH/ SMALL,BIG,EXPARG
...
C*****precision > double
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (PI = 3.14159265, AVAG = 6.022D23)
C*****END precision > double
C*****precision > single
      IMPLICIT REAL (A-H, O-Z), INTEGER (I-N)
      PARAMETER (PI = 3.14159265, AVAG = 6.022E23)
C*****END precision > single
C
      INCLUDE 'ckstrt.h'
      COMMON /MACH/ SMALL,BIG,EXPARG
...
C*****precision > double
C      PARAMETER (RU=8.314510D7, RUC=RU/4.184D7, PA=1.01325D6)
C*****END precision > double
C*****precision > single
      PARAMETER (RU=8.314510E7, RUC=RU/4.184E7, PA=1.01325E6)
C*****END precision > single
C
      DIMENSION ICKWRK(*), RCKWRK(*)
      CHARACTER*(*) CCKWRK(*)
...
C                                                                      C
C*****precision > double
C      DOUBLE PRECISION FUNCTION CKSUM (ARRAY, NN)
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C*****END precision > double
C*****precision > single
...
C*****precision > double
C      IMPLICIT DOUBLE PRECISION (A-H, O-Z), INTEGER (I-N)
C      PARAMETER (PI = 3.14159265, PERM0 = 8.854D-7, ECHRG=1.6022D-12,
C     1           AVAG = 6.022D23, SMALLX = 1.D-50)
C*****END precision > double
C*****precision > single
      IMPLICIT REAL (A-H, O-Z), INTEGER (I-N)
      PARAMETER (PI = 3.14159265, PERM0 = 8.854E-7, ECHRG=1.6022E-12,
     1           AVAG = 6.022E23, SMALLX = 1.E-30)
C*****END precision > single
C
      INCLUDE 'ckstrt.h'
      COMMON /MACH/ SMALL,BIG,EXPARG
