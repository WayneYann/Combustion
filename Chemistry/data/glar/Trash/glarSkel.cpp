...
void CKCPBS(double *T, double *y, int * iwrk, double * rwrk, double * cpbs)
{
    ...
    result += cpor[1]*y[1]/15.999400; /*O */
    result += cpor[2]*y[2]/17.007370; /*OH */
    result += cpor[3]*y[3]/2.015940; /*H2 */
    result += cpor[4]*y[4]/31.998800; /*O2 */
    result += cpor[5]*y[5]/33.006770; /*HO2 */
    result += cpor[6]*y[6]/18.015340; /*H2O */
    result += cpor[7]*y[7]/34.014740; /*H2O2 */
    result += cpor[8]*y[8]/30.006100; /*NO */
    result += cpor[9]*y[9]/46.005500; /*NO2 */
    result += cpor[10]*y[10]/44.012800; /*N2O */
    result += cpor[11]*y[11]/15.014670; /*NH */
    result += cpor[12]*y[12]/14.006700; /*N */
    result += cpor[13]*y[13]/29.021370; /*NNH */
    result += cpor[14]*y[14]/28.013400; /*N2 */
...
void CKCVBS(double *T, double *y, int * iwrk, double * rwrk, double * cvbs)
{
    ...
    result += cvor[1]*y[1]/15.999400; /*O */
    result += cvor[2]*y[2]/17.007370; /*OH */
    result += cvor[3]*y[3]/2.015940; /*H2 */
    result += cvor[4]*y[4]/31.998800; /*O2 */
    result += cvor[5]*y[5]/33.006770; /*HO2 */
    result += cvor[6]*y[6]/18.015340; /*H2O */
    result += cvor[7]*y[7]/34.014740; /*H2O2 */
    result += cvor[8]*y[8]/30.006100; /*NO */
    result += cvor[9]*y[9]/46.005500; /*NO2 */
    result += cvor[10]*y[10]/44.012800; /*N2O */
    result += cvor[11]*y[11]/15.014670; /*NH */
    result += cvor[12]*y[12]/14.006700; /*N */
    result += cvor[13]*y[13]/29.021370; /*NNH */
    result += cvor[14]*y[14]/28.013400; /*N2 */
