...
void CKCVMS(double * restrict T, int * iwrk, double * restrict rwrk, double * restrict cvms)
{
    ...
    cvms[1] *= 2.968047434442088e+06; /*N2 */
}
...
void CKCPMS(double * restrict T, int * iwrk, double * restrict rwrk, double * restrict cpms)
{
    ...
    cpms[1] *= 2.968047434442088e+06; /*N2 */
}
...
void CKSMS(double * restrict T, int * iwrk, double * restrict rwrk, double * restrict sms)
{
    ...
    sms[1] *= 2.968047434442088e+06; /*N2 */
}
...
void egtransetCOFLAM(double* COFLAM) {
  COFLAM[           0] =  -0.2128535787521960E+01;
  COFLAM[           1] =   0.2989596575804116E+01;
  COFLAM[           2] =  -0.2874009536723909E+00;
  COFLAM[           3] =   0.1240808902994658E-01;
  COFLAM[           4] =   0.7598771527433207E+01;
  COFLAM[           5] =  -0.1179708291725760E+01;
  COFLAM[           6] =   0.3029588826051161E+00;
  COFLAM[           7] =  -0.1538941570998816E-01;
};
#if defined(BL_FORT_USE_UPPERCASE)
...
void egtransetCOFETA(double* COFETA) {
  COFETA[           0] =  -0.1602272818500447E+02;
  COFETA[           1] =   0.2173986581363982E+01;
  COFETA[           2] =  -0.1980867737685871E+00;
  COFETA[           3] =   0.8538618302987773E-02;
  COFETA[           4] =  -0.1554301373538047E+02;
  COFETA[           5] =   0.1934050217437019E+01;
  COFETA[           6] =  -0.1673658048743626E+00;
  COFETA[           7] =   0.7228254732832448E-02;
};
#if defined(BL_FORT_USE_UPPERCASE)
...
void egtransetCOFD(double* COFD) {
  COFD[           0] =  -0.1506605758131460E+02;
  COFD[           1] =   0.3251697055272910E+01;
  COFD[           2] =  -0.2050406569622160E+00;
  COFD[           3] =   0.8763175375306562E-02;
  COFD[           4] =  -0.1475676271878258E+02;
  COFD[           5] =   0.3131581686069595E+01;
  COFD[           6] =  -0.1897184400551578E+00;
  COFD[           7] =   0.8111551924229800E-02;
  COFD[           8] =  -0.1475676271878258E+02;
  COFD[           9] =   0.3131581686069595E+01;
  COFD[          10] =  -0.1897184400551578E+00;
  COFD[          11] =   0.8111551924229800E-02;
  COFD[          12] =  -0.1453137348852218E+02;
  COFD[          13] =   0.3046804301681465E+01;
  COFD[          14] =  -0.1793667137201395E+00;
  COFD[          15] =   0.7690228126606375E-02;
};
#if defined(BL_FORT_USE_UPPERCASE)
