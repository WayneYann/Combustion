...
void aJacobian(double * restrict J, double * restrict sc, double T, int consP)
{
    ...
    if (consP) {
        ...
        /* d()/d[H] */
        dqdci =  + k_f*sc[2];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[24] += -1 * dqdci;          /* dwdot[O]/d[H] */
        J[26] += 1 * dqdci;           /* dwdot[OH]/d[H] */
        /* d()/d[O] */
        dqdci =  + k_f*sc[1];
        J[45] += -1 * dqdci;          /* dwdot[H]/d[O] */
        J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
        J[48] += 1 * dqdci;           /* dwdot[OH]/d[O] */
        /* d()/d[OH] */
        dqdci =  - k_r;
        J[89] += -1 * dqdci;          /* dwdot[H]/d[OH] */
        J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
        J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
        /* d()/d[H2O] */
        dqdci =  5*q_nocor;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[112] += -1 * dqdci;         /* dwdot[O]/d[H2O] */
        J[114] += 1 * dqdci;          /* dwdot[OH]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*q_nocor;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[222] += -1 * dqdci;         /* dwdot[O]/d[CH4] */
        J[224] += 1 * dqdci;          /* dwdot[OH]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*q_nocor;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[244] += -1 * dqdci;         /* dwdot[O]/d[CO] */
        J[246] += 1 * dqdci;          /* dwdot[OH]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*q_nocor;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[266] += -1 * dqdci;         /* dwdot[O]/d[CO2] */
        J[268] += 1 * dqdci;          /* dwdot[OH]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  2*q_nocor;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[398] += -1 * dqdci;         /* dwdot[O]/d[C2H6] */
        J[400] += 1 * dqdci;          /* dwdot[OH]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.3*q_nocor;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[442] += -1 * dqdci;         /* dwdot[O]/d[AR] */
        J[444] += 1 * dqdci;          /* dwdot[OH]/d[AR] */
    }
    else {
        dqdc[0] =  2*q_nocor;
    ...
    J[463] += -1 * dqdT; /* dwdot[H]/dT */
    J[464] += -1 * dqdT; /* dwdot[O]/dT */
    J[466] += 1 * dqdT; /* dwdot[OH]/dT */
    ...
    /* d()/d[H] */
    dqdci =  - k_r*sc[4];
    J[22] += -1 * dqdci;          /* dwdot[H2]/d[H] */
    J[23] += 1 * dqdci;           /* dwdot[H]/d[H] */
    J[24] += -1 * dqdci;          /* dwdot[O]/d[H] */
    J[26] += 1 * dqdci;           /* dwdot[OH]/d[H] */
    /* d()/d[O] */
    dqdci =  + k_f*sc[0];
    J[44] += -1 * dqdci;          /* dwdot[H2]/d[O] */
    J[45] += 1 * dqdci;           /* dwdot[H]/d[O] */
    J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
    J[48] += 1 * dqdci;           /* dwdot[OH]/d[O] */
    /* d()/d[OH] */
    dqdci =  - k_r*sc[1];
    J[88] += -1 * dqdci;          /* dwdot[H2]/d[OH] */
    J[89] += 1 * dqdci;           /* dwdot[H]/d[OH] */
    J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    /* d()/dT */
    J[462] += -1 * dqdT;          /* dwdot[H2]/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    ...
    dqdci =  + k_f*sc[6];
    J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
    J[47] += 1 * dqdci;           /* dwdot[O2]/d[O] */
    J[48] += 1 * dqdci;           /* dwdot[OH]/d[O] */
    J[50] += -1 * dqdci;          /* dwdot[HO2]/d[O] */
    /* d()/d[O2] */
    dqdci =  - k_r*sc[4];
    J[68] += -1 * dqdci;          /* dwdot[O]/d[O2] */
    J[69] += 1 * dqdci;           /* dwdot[O2]/d[O2] */
    J[70] += 1 * dqdci;           /* dwdot[OH]/d[O2] */
    J[72] += -1 * dqdci;          /* dwdot[HO2]/d[O2] */
    /* d()/d[OH] */
    dqdci =  - k_r*sc[3];
    J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
    J[91] += 1 * dqdci;           /* dwdot[O2]/d[OH] */
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[94] += -1 * dqdci;          /* dwdot[HO2]/d[OH] */
    /* d()/d[HO2] */
    dqdci =  + k_f*sc[2];
    J[134] += -1 * dqdci;         /* dwdot[O]/d[HO2] */
    J[135] += 1 * dqdci;          /* dwdot[O2]/d[HO2] */
    J[136] += 1 * dqdci;          /* dwdot[OH]/d[HO2] */
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[465] += 1 * dqdT;           /* dwdot[O2]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    J[468] += -1 * dqdT;          /* dwdot[HO2]/dT */
    ...
    /* reverse */
    phi_r = sc[1]*sc[13];
    Kc = exp((g_RT[7] + g_RT[2]) - (g_RT[1] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[2]) + (h_RT[1] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[23] += 1 * dqdci;           /* dwdot[H]/d[H] */
    J[24] += -1 * dqdci;          /* dwdot[O]/d[H] */
    J[29] += -1 * dqdci;          /* dwdot[CH2]/d[H] */
    J[35] += 1 * dqdci;           /* dwdot[HCO]/d[H] */
    /* d()/d[O] */
    dqdci =  + k_f*sc[7];
    J[45] += 1 * dqdci;           /* dwdot[H]/d[O] */
    J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
    J[51] += -1 * dqdci;          /* dwdot[CH2]/d[O] */
    J[57] += 1 * dqdci;           /* dwdot[HCO]/d[O] */
    /* d()/d[CH2] */
    dqdci =  + k_f*sc[2];
    J[155] += 1 * dqdci;          /* dwdot[H]/d[CH2] */
    J[156] += -1 * dqdci;         /* dwdot[O]/d[CH2] */
    J[161] += -1 * dqdci;         /* dwdot[CH2]/d[CH2] */
    J[167] += 1 * dqdci;          /* dwdot[HCO]/d[CH2] */
    /* d()/d[HCO] */
    dqdci =  - k_r*sc[1];
    J[287] += 1 * dqdci;          /* dwdot[H]/d[HCO] */
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[293] += -1 * dqdci;         /* dwdot[CH2]/d[HCO] */
    J[299] += 1 * dqdci;          /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[469] += -1 * dqdT;          /* dwdot[CH2]/dT */
    J[475] += 1 * dqdT;           /* dwdot[HCO]/dT */
    ...
    /* reverse */
    phi_r = sc[1]*sc[13];
    Kc = exp((g_RT[8] + g_RT[2]) - (g_RT[1] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[2]) + (h_RT[1] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[23] += 1 * dqdci;           /* dwdot[H]/d[H] */
    J[24] += -1 * dqdci;          /* dwdot[O]/d[H] */
    J[30] += -1 * dqdci;          /* dwdot[CH2(S)]/d[H] */
    J[35] += 1 * dqdci;           /* dwdot[HCO]/d[H] */
    /* d()/d[O] */
    dqdci =  + k_f*sc[8];
    J[45] += 1 * dqdci;           /* dwdot[H]/d[O] */
    J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
    J[52] += -1 * dqdci;          /* dwdot[CH2(S)]/d[O] */
    J[57] += 1 * dqdci;           /* dwdot[HCO]/d[O] */
    /* d()/d[CH2(S)] */
    dqdci =  + k_f*sc[2];
    J[177] += 1 * dqdci;          /* dwdot[H]/d[CH2(S)] */
    J[178] += -1 * dqdci;         /* dwdot[O]/d[CH2(S)] */
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[189] += 1 * dqdci;          /* dwdot[HCO]/d[CH2(S)] */
    /* d()/d[HCO] */
    dqdci =  - k_r*sc[1];
    J[287] += 1 * dqdci;          /* dwdot[H]/d[HCO] */
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[294] += -1 * dqdci;         /* dwdot[CH2(S)]/d[HCO] */
    J[299] += 1 * dqdci;          /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    J[475] += 1 * dqdT;           /* dwdot[HCO]/dT */
    ...
    J[23] += 1 * dqdci;           /* dwdot[H]/d[H] */
    J[24] += -1 * dqdci;          /* dwdot[O]/d[H] */
    J[31] += -1 * dqdci;          /* dwdot[CH3]/d[H] */
    J[36] += 1 * dqdci;           /* dwdot[CH2O]/d[H] */
    /* d()/d[O] */
    dqdci =  + k_f*sc[9];
    J[45] += 1 * dqdci;           /* dwdot[H]/d[O] */
    J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
    J[53] += -1 * dqdci;          /* dwdot[CH3]/d[O] */
    J[58] += 1 * dqdci;           /* dwdot[CH2O]/d[O] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[2];
    J[199] += 1 * dqdci;          /* dwdot[H]/d[CH3] */
    J[200] += -1 * dqdci;         /* dwdot[O]/d[CH3] */
    J[207] += -1 * dqdci;         /* dwdot[CH3]/d[CH3] */
    J[212] += 1 * dqdci;          /* dwdot[CH2O]/d[CH3] */
    /* d()/d[CH2O] */
    dqdci =  - k_r*sc[1];
    J[309] += 1 * dqdci;          /* dwdot[H]/d[CH2O] */
    J[310] += -1 * dqdci;         /* dwdot[O]/d[CH2O] */
    J[317] += -1 * dqdci;         /* dwdot[CH3]/d[CH2O] */
    J[322] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[471] += -1 * dqdT;          /* dwdot[CH3]/dT */
    J[476] += 1 * dqdT;           /* dwdot[CH2O]/dT */
    ...
    /* reverse */
    phi_r = sc[9]*sc[4];
    Kc = exp((g_RT[10] + g_RT[2]) - (g_RT[9] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[10] + h_RT[2]) + (h_RT[9] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[48] += 1 * dqdci;           /* dwdot[OH]/d[O] */
    J[53] += 1 * dqdci;           /* dwdot[CH3]/d[O] */
    J[54] += -1 * dqdci;          /* dwdot[CH4]/d[O] */
    /* d()/d[OH] */
    dqdci =  - k_r*sc[9];
    J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[97] += 1 * dqdci;           /* dwdot[CH3]/d[OH] */
    J[98] += -1 * dqdci;          /* dwdot[CH4]/d[OH] */
    /* d()/d[CH3] */
    dqdci =  - k_r*sc[4];
    J[200] += -1 * dqdci;         /* dwdot[O]/d[CH3] */
    J[202] += 1 * dqdci;          /* dwdot[OH]/d[CH3] */
    J[207] += 1 * dqdci;          /* dwdot[CH3]/d[CH3] */
    J[208] += -1 * dqdci;         /* dwdot[CH4]/d[CH3] */
    /* d()/d[CH4] */
    dqdci =  + k_f*sc[2];
    J[222] += -1 * dqdci;         /* dwdot[O]/d[CH4] */
    J[224] += 1 * dqdci;          /* dwdot[OH]/d[CH4] */
    J[229] += 1 * dqdci;          /* dwdot[CH3]/d[CH4] */
    J[230] += -1 * dqdci;         /* dwdot[CH4]/d[CH4] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    J[471] += 1 * dqdT;           /* dwdot[CH3]/dT */
    J[472] += -1 * dqdT;          /* dwdot[CH4]/dT */
    ...
    /* reverse */
    phi_r = sc[12];
    Kc = refCinv * exp((g_RT[11] + g_RT[2]) - (g_RT[12]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[11] + h_RT[2]) + (h_RT[12]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    q = alpha * q_nocor;
    ...
    if (consP) {
        ...
        dqdci =  1*q_nocor;
        J[2] += -1 * dqdci;           /* dwdot[O]/d[H2] */
        J[11] += -1 * dqdci;          /* dwdot[CO]/d[H2] */
        J[12] += 1 * dqdci;           /* dwdot[CO2]/d[H2] */
        /* d()/d[O] */
        dqdci =  + k_f*sc[11];
        J[46] += -1 * dqdci;          /* dwdot[O]/d[O] */
        J[55] += -1 * dqdci;          /* dwdot[CO]/d[O] */
        J[56] += 1 * dqdci;           /* dwdot[CO2]/d[O] */
        /* d()/d[O2] */
        dqdci =  5*q_nocor;
        J[68] += -1 * dqdci;          /* dwdot[O]/d[O2] */
        J[77] += -1 * dqdci;          /* dwdot[CO]/d[O2] */
        J[78] += 1 * dqdci;           /* dwdot[CO2]/d[O2] */
        /* d()/d[H2O] */
        dqdci =  5*q_nocor;
        J[112] += -1 * dqdci;         /* dwdot[O]/d[H2O] */
        J[121] += -1 * dqdci;         /* dwdot[CO]/d[H2O] */
        J[122] += 1 * dqdci;          /* dwdot[CO2]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*q_nocor;
        J[222] += -1 * dqdci;         /* dwdot[O]/d[CH4] */
        J[231] += -1 * dqdci;         /* dwdot[CO]/d[CH4] */
        J[232] += 1 * dqdci;          /* dwdot[CO2]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*q_nocor + k_f*sc[2];
        J[244] += -1 * dqdci;         /* dwdot[O]/d[CO] */
        J[253] += -1 * dqdci;         /* dwdot[CO]/d[CO] */
        J[254] += 1 * dqdci;          /* dwdot[CO2]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  2.5*q_nocor - k_r;
        J[266] += -1 * dqdci;         /* dwdot[O]/d[CO2] */
        J[275] += -1 * dqdci;         /* dwdot[CO]/d[CO2] */
        J[276] += 1 * dqdci;          /* dwdot[CO2]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  2*q_nocor;
        J[398] += -1 * dqdci;         /* dwdot[O]/d[C2H6] */
        J[407] += -1 * dqdci;         /* dwdot[CO]/d[C2H6] */
        J[408] += 1 * dqdci;          /* dwdot[CO2]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.5*q_nocor;
        J[442] += -1 * dqdci;         /* dwdot[O]/d[AR] */
        J[451] += -1 * dqdci;         /* dwdot[CO]/d[AR] */
        J[452] += 1 * dqdci;          /* dwdot[CO2]/d[AR] */
    }
    else {
        dqdc[0] =  2*q_nocor;
        dqdc[1] =  1*q_nocor;
        dqdc[2] =  1*q_nocor + k_f*sc[11];
        dqdc[3] =  6*q_nocor;
        dqdc[4] =  1*q_nocor;
        dqdc[5] =  6*q_nocor;
        dqdc[6] =  1*q_nocor;
    ...
    J[464] += -1 * dqdT; /* dwdot[O]/dT */
    J[473] += -1 * dqdT; /* dwdot[CO]/dT */
    J[474] += 1 * dqdT; /* dwdot[CO2]/dT */
    ...
    /* reverse */
    phi_r = sc[11]*sc[4];
    Kc = exp((g_RT[13] + g_RT[2]) - (g_RT[11] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[13] + h_RT[2]) + (h_RT[11] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[99] += 1 * dqdci;           /* dwdot[CO]/d[OH] */
    J[101] += -1 * dqdci;         /* dwdot[HCO]/d[OH] */
    /* d()/d[CO] */
    dqdci =  - k_r*sc[4];
    J[244] += -1 * dqdci;         /* dwdot[O]/d[CO] */
    J[246] += 1 * dqdci;          /* dwdot[OH]/d[CO] */
    J[253] += 1 * dqdci;          /* dwdot[CO]/d[CO] */
    J[255] += -1 * dqdci;         /* dwdot[HCO]/d[CO] */
    /* d()/d[HCO] */
    dqdci =  + k_f*sc[2];
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[290] += 1 * dqdci;          /* dwdot[OH]/d[HCO] */
    J[297] += 1 * dqdci;          /* dwdot[CO]/d[HCO] */
    J[299] += -1 * dqdci;         /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[12]*sc[1];
    Kc = exp((g_RT[13] + g_RT[2]) - (g_RT[12] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[13] + h_RT[2]) + (h_RT[12] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[266] += -1 * dqdci;         /* dwdot[O]/d[CO2] */
    J[276] += 1 * dqdci;          /* dwdot[CO2]/d[CO2] */
    J[277] += -1 * dqdci;         /* dwdot[HCO]/d[CO2] */
    /* d()/d[HCO] */
    dqdci =  + k_f*sc[2];
    J[287] += 1 * dqdci;          /* dwdot[H]/d[HCO] */
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[298] += 1 * dqdci;          /* dwdot[CO2]/d[HCO] */
    J[299] += -1 * dqdci;         /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    ...
    /* reverse */
    phi_r = sc[13]*sc[4];
    Kc = exp((g_RT[14] + g_RT[2]) - (g_RT[13] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[2]) + (h_RT[13] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[101] += 1 * dqdci;          /* dwdot[HCO]/d[OH] */
    J[102] += -1 * dqdci;         /* dwdot[CH2O]/d[OH] */
    /* d()/d[HCO] */
    dqdci =  - k_r*sc[4];
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[290] += 1 * dqdci;          /* dwdot[OH]/d[HCO] */
    J[299] += 1 * dqdci;          /* dwdot[HCO]/d[HCO] */
    J[300] += -1 * dqdci;         /* dwdot[CH2O]/d[HCO] */
    /* d()/d[CH2O] */
    dqdci =  + k_f*sc[2];
    J[310] += -1 * dqdci;         /* dwdot[O]/d[CH2O] */
    J[312] += 1 * dqdci;          /* dwdot[OH]/d[CH2O] */
    J[321] += 1 * dqdci;          /* dwdot[HCO]/d[CH2O] */
    J[322] += -1 * dqdci;         /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[9]*sc[13];
    Kc = exp((g_RT[16] + g_RT[2]) - (g_RT[9] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[16] + h_RT[2]) + (h_RT[9] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[53] += 1 * dqdci;           /* dwdot[CH3]/d[O] */
    J[57] += 1 * dqdci;           /* dwdot[HCO]/d[O] */
    J[60] += -1 * dqdci;          /* dwdot[C2H4]/d[O] */
    /* d()/d[CH3] */
    dqdci =  - k_r*sc[13];
    J[200] += -1 * dqdci;         /* dwdot[O]/d[CH3] */
    J[207] += 1 * dqdci;          /* dwdot[CH3]/d[CH3] */
    J[211] += 1 * dqdci;          /* dwdot[HCO]/d[CH3] */
    J[214] += -1 * dqdci;         /* dwdot[C2H4]/d[CH3] */
    /* d()/d[HCO] */
    dqdci =  - k_r*sc[9];
    J[288] += -1 * dqdci;         /* dwdot[O]/d[HCO] */
    J[295] += 1 * dqdci;          /* dwdot[CH3]/d[HCO] */
    J[299] += 1 * dqdci;          /* dwdot[HCO]/d[HCO] */
    J[302] += -1 * dqdci;         /* dwdot[C2H4]/d[HCO] */
    /* d()/d[C2H4] */
    dqdci =  + k_f*sc[2];
    J[354] += -1 * dqdci;         /* dwdot[O]/d[C2H4] */
    J[361] += 1 * dqdci;          /* dwdot[CH3]/d[C2H4] */
    J[365] += 1 * dqdci;          /* dwdot[HCO]/d[C2H4] */
    J[368] += -1 * dqdci;         /* dwdot[C2H4]/d[C2H4] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[471] += 1 * dqdT;           /* dwdot[CH3]/dT */
    J[475] += 1 * dqdT;           /* dwdot[HCO]/dT */
    J[478] += -1 * dqdT;          /* dwdot[C2H4]/dT */
    ...
    /* reverse */
    phi_r = sc[14]*sc[9];
    Kc = exp((g_RT[17] + g_RT[2]) - (g_RT[14] + g_RT[9]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[17] + h_RT[2]) + (h_RT[14] + h_RT[9]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[53] += 1 * dqdci;           /* dwdot[CH3]/d[O] */
    J[58] += 1 * dqdci;           /* dwdot[CH2O]/d[O] */
    J[61] += -1 * dqdci;          /* dwdot[C2H5]/d[O] */
    /* d()/d[CH3] */
    dqdci =  - k_r*sc[14];
    J[200] += -1 * dqdci;         /* dwdot[O]/d[CH3] */
    J[207] += 1 * dqdci;          /* dwdot[CH3]/d[CH3] */
    J[212] += 1 * dqdci;          /* dwdot[CH2O]/d[CH3] */
    J[215] += -1 * dqdci;         /* dwdot[C2H5]/d[CH3] */
    /* d()/d[CH2O] */
    dqdci =  - k_r*sc[9];
    J[310] += -1 * dqdci;         /* dwdot[O]/d[CH2O] */
    J[317] += 1 * dqdci;          /* dwdot[CH3]/d[CH2O] */
    J[322] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2O] */
    J[325] += -1 * dqdci;         /* dwdot[C2H5]/d[CH2O] */
    /* d()/d[C2H5] */
    dqdci =  + k_f*sc[2];
    J[376] += -1 * dqdci;         /* dwdot[O]/d[C2H5] */
    J[383] += 1 * dqdci;          /* dwdot[CH3]/d[C2H5] */
    J[388] += 1 * dqdci;          /* dwdot[CH2O]/d[C2H5] */
    J[391] += -1 * dqdci;         /* dwdot[C2H5]/d[C2H5] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[471] += 1 * dqdT;           /* dwdot[CH3]/dT */
    J[476] += 1 * dqdT;           /* dwdot[CH2O]/dT */
    J[479] += -1 * dqdT;          /* dwdot[C2H5]/dT */
    ...
    J[48] += 1 * dqdci;           /* dwdot[OH]/d[O] */
    J[61] += 1 * dqdci;           /* dwdot[C2H5]/d[O] */
    J[62] += -1 * dqdci;          /* dwdot[C2H6]/d[O] */
    /* d()/d[OH] */
    dqdci =  - k_r*sc[17];
    J[90] += -1 * dqdci;          /* dwdot[O]/d[OH] */
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[105] += 1 * dqdci;          /* dwdot[C2H5]/d[OH] */
    J[106] += -1 * dqdci;         /* dwdot[C2H6]/d[OH] */
    /* d()/d[C2H5] */
    dqdci =  - k_r*sc[4];
    J[376] += -1 * dqdci;         /* dwdot[O]/d[C2H5] */
    J[378] += 1 * dqdci;          /* dwdot[OH]/d[C2H5] */
    J[391] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H5] */
    J[392] += -1 * dqdci;         /* dwdot[C2H6]/d[C2H5] */
    /* d()/d[C2H6] */
    dqdci =  + k_f*sc[2];
    J[398] += -1 * dqdci;         /* dwdot[O]/d[C2H6] */
    J[400] += 1 * dqdci;          /* dwdot[OH]/d[C2H6] */
    J[413] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H6] */
    J[414] += -1 * dqdci;         /* dwdot[C2H6]/d[C2H6] */
    /* d()/dT */
    J[464] += -1 * dqdT;          /* dwdot[O]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    J[479] += 1 * dqdT;           /* dwdot[C2H5]/dT */
    J[480] += -1 * dqdT;          /* dwdot[C2H6]/dT */
    ...
    /* reverse */
    phi_r = sc[12]*sc[2];
    Kc = exp((g_RT[11] + g_RT[3]) - (g_RT[12] + g_RT[2]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[11] + h_RT[3]) + (h_RT[12] + h_RT[2]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  + k_f*sc[3];
    J[244] += 1 * dqdci;          /* dwdot[O]/d[CO] */
    J[245] += -1 * dqdci;         /* dwdot[O2]/d[CO] */
    J[253] += -1 * dqdci;         /* dwdot[CO]/d[CO] */
    J[254] += 1 * dqdci;          /* dwdot[CO2]/d[CO] */
    /* d()/d[CO2] */
    dqdci =  - k_r*sc[2];
    J[266] += 1 * dqdci;          /* dwdot[O]/d[CO2] */
    J[267] += -1 * dqdci;         /* dwdot[O2]/d[CO2] */
    J[275] += -1 * dqdci;         /* dwdot[CO]/d[CO2] */
    J[276] += 1 * dqdci;          /* dwdot[CO2]/d[CO2] */
    /* d()/dT */
    J[464] += 1 * dqdT;           /* dwdot[O]/dT */
    ...
    /* reverse */
    phi_r = sc[13]*sc[6];
    Kc = exp((g_RT[14] + g_RT[3]) - (g_RT[13] + g_RT[6]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[3]) + (h_RT[13] + h_RT[6]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[69] += -1 * dqdci;          /* dwdot[O2]/d[O2] */
    J[72] += 1 * dqdci;           /* dwdot[HO2]/d[O2] */
    J[79] += 1 * dqdci;           /* dwdot[HCO]/d[O2] */
    J[80] += -1 * dqdci;          /* dwdot[CH2O]/d[O2] */
    /* d()/d[HO2] */
    dqdci =  - k_r*sc[13];
    J[135] += -1 * dqdci;         /* dwdot[O2]/d[HO2] */
    J[138] += 1 * dqdci;          /* dwdot[HO2]/d[HO2] */
    J[145] += 1 * dqdci;          /* dwdot[HCO]/d[HO2] */
    J[146] += -1 * dqdci;         /* dwdot[CH2O]/d[HO2] */
    /* d()/d[HCO] */
    dqdci =  - k_r*sc[6];
    J[289] += -1 * dqdci;         /* dwdot[O2]/d[HCO] */
    J[292] += 1 * dqdci;          /* dwdot[HO2]/d[HCO] */
    J[299] += 1 * dqdci;          /* dwdot[HCO]/d[HCO] */
    J[300] += -1 * dqdci;         /* dwdot[CH2O]/d[HCO] */
    /* d()/d[CH2O] */
    dqdci =  + k_f*sc[3];
    J[311] += -1 * dqdci;         /* dwdot[O2]/d[CH2O] */
    J[314] += 1 * dqdci;          /* dwdot[HO2]/d[CH2O] */
    J[321] += 1 * dqdci;          /* dwdot[HCO]/d[CH2O] */
    J[322] += -1 * dqdci;         /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[465] += -1 * dqdT;          /* dwdot[O2]/dT */
    ...
    if (consP) {
        ...
        dqdci =  + k_f*sc[3];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[25] += -1 * dqdci;          /* dwdot[O2]/d[H] */
        J[28] += 1 * dqdci;           /* dwdot[HO2]/d[H] */
        /* d()/d[O2] */
        dqdci =  -1*q_nocor + k_f*sc[1];
        J[67] += -1 * dqdci;          /* dwdot[H]/d[O2] */
        J[69] += -1 * dqdci;          /* dwdot[O2]/d[O2] */
        J[72] += 1 * dqdci;           /* dwdot[HO2]/d[O2] */
        /* d()/d[H2O] */
        dqdci =  -1*q_nocor;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[113] += -1 * dqdci;         /* dwdot[O2]/d[H2O] */
        J[116] += 1 * dqdci;          /* dwdot[HO2]/d[H2O] */
        /* d()/d[HO2] */
        dqdci =  - k_r;
        J[133] += -1 * dqdci;         /* dwdot[H]/d[HO2] */
        J[135] += -1 * dqdci;         /* dwdot[O2]/d[HO2] */
        J[138] += 1 * dqdci;          /* dwdot[HO2]/d[HO2] */
        /* d()/d[CO] */
        dqdci =  -0.25*q_nocor;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[245] += -1 * dqdci;         /* dwdot[O2]/d[CO] */
        J[248] += 1 * dqdci;          /* dwdot[HO2]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  0.5*q_nocor;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[267] += -1 * dqdci;         /* dwdot[O2]/d[CO2] */
        J[270] += 1 * dqdci;          /* dwdot[HO2]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  0.5*q_nocor;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[399] += -1 * dqdci;         /* dwdot[O2]/d[C2H6] */
        J[402] += 1 * dqdci;          /* dwdot[HO2]/d[C2H6] */
        /* d()/d[N2] */
        dqdci =  -1*q_nocor;
        J[419] += -1 * dqdci;         /* dwdot[H]/d[N2] */
        J[421] += -1 * dqdci;         /* dwdot[O2]/d[N2] */
        J[424] += 1 * dqdci;          /* dwdot[HO2]/d[N2] */
        /* d()/d[AR] */
        dqdci =  -1*q_nocor;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[443] += -1 * dqdci;         /* dwdot[O2]/d[AR] */
        J[446] += 1 * dqdci;          /* dwdot[HO2]/d[AR] */
    }
    else {
        dqdc[0] =  1*q_nocor;
    ...
    /*a non-third-body and non-pressure-fall-off reaction */
    /* forward */
    phi_f = sc[1]*sc[19]*sc[3];
    k_f = 1e-12 * 3.75e+20*exp(-1.72*tc[0]);
    dlnkfdT = -1.72 * invT;
    /* reverse */
    phi_r = sc[6]*sc[19];
    Kc = refCinv * exp((g_RT[1] + g_RT[19] + g_RT[3]) - (g_RT[6] + g_RT[19]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[1] + h_RT[19] + h_RT[3]) + (h_RT[6] + h_RT[19]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /*a non-third-body and non-pressure-fall-off reaction */
    /* forward */
    phi_f = sc[20]*sc[1]*sc[3];
    k_f = 1e-12 * 7e+17*exp(-0.8*tc[0]);
    dlnkfdT = -0.8 * invT;
    /* reverse */
    phi_r = sc[20]*sc[6];
    Kc = refCinv * exp((g_RT[20] + g_RT[1] + g_RT[3]) - (g_RT[20] + g_RT[6]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[20] + h_RT[1] + h_RT[3]) + (h_RT[20] + h_RT[6]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    wdot[6] += q; /* HO2 */
    /* d()/d[H] */
    dqdci =  + k_f*sc[20]*sc[3];
    J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
    J[25] += -1 * dqdci;          /* dwdot[O2]/d[H] */
    J[28] += 1 * dqdci;           /* dwdot[HO2]/d[H] */
    /* d()/d[O2] */
    dqdci =  + k_f*sc[20]*sc[1];
    J[67] += -1 * dqdci;          /* dwdot[H]/d[O2] */
    J[69] += -1 * dqdci;          /* dwdot[O2]/d[O2] */
    J[72] += 1 * dqdci;           /* dwdot[HO2]/d[O2] */
    /* d()/d[HO2] */
    ...
    if (consP) {
        ...
        /* d()/d[H2O] */
        dqdci =  -1*q_nocor;
        J[110] += 1 * dqdci;          /* dwdot[H2]/d[H2O] */
        J[111] += -2 * dqdci;         /* dwdot[H]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*q_nocor;
        J[220] += 1 * dqdci;          /* dwdot[H2]/d[CH4] */
        J[221] += -2 * dqdci;         /* dwdot[H]/d[CH4] */
        /* d()/d[CO2] */
        dqdci =  -1*q_nocor;
        J[264] += 1 * dqdci;          /* dwdot[H2]/d[CO2] */
        J[265] += -2 * dqdci;         /* dwdot[H]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  2*q_nocor;
        J[396] += 1 * dqdci;          /* dwdot[H2]/d[C2H6] */
        J[397] += -2 * dqdci;         /* dwdot[H]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.37*q_nocor;
        J[440] += 1 * dqdci;          /* dwdot[H2]/d[AR] */
    ...
    /*a non-third-body and non-pressure-fall-off reaction */
    /* forward */
    phi_f = sc[12]*sc[1]*sc[1];
    k_f = 1e-12 * 5.5e+20*exp(-2*tc[0]);
    dlnkfdT = -2 * invT;
    /* reverse */
    phi_r = sc[12]*sc[0];
    Kc = refCinv * exp((g_RT[12] + 2 * g_RT[1]) - (g_RT[12] + g_RT[0]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[12] + 2*h_RT[1]) + (h_RT[12] + h_RT[0]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    if (consP) {
        ...
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[26] += -1 * dqdci;          /* dwdot[OH]/d[H] */
        J[27] += 1 * dqdci;           /* dwdot[H2O]/d[H] */
        /* d()/d[OH] */
        dqdci =  + k_f*sc[1];
        J[89] += -1 * dqdci;          /* dwdot[H]/d[OH] */
        J[92] += -1 * dqdci;          /* dwdot[OH]/d[OH] */
        J[93] += 1 * dqdci;           /* dwdot[H2O]/d[OH] */
        /* d()/d[H2O] */
        dqdci =  2.65*q_nocor - k_r;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[114] += -1 * dqdci;         /* dwdot[OH]/d[H2O] */
        J[115] += 1 * dqdci;          /* dwdot[H2O]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*q_nocor;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[224] += -1 * dqdci;         /* dwdot[OH]/d[CH4] */
        J[225] += 1 * dqdci;          /* dwdot[H2O]/d[CH4] */
        /* d()/d[C2H6] */
        dqdci =  2*q_nocor;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[400] += -1 * dqdci;         /* dwdot[OH]/d[C2H6] */
        J[401] += 1 * dqdci;          /* dwdot[H2O]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.62*q_nocor;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[444] += -1 * dqdci;         /* dwdot[OH]/d[AR] */
        J[445] += 1 * dqdci;          /* dwdot[H2O]/d[AR] */
    }
    else {
        dqdc[0] =  0.73*q_nocor;
    ...
    /* d()/d[O2] */
    dqdci =  - k_r*sc[0];
    J[66] += 1 * dqdci;           /* dwdot[H2]/d[O2] */
    J[67] += -1 * dqdci;          /* dwdot[H]/d[O2] */
    J[69] += 1 * dqdci;           /* dwdot[O2]/d[O2] */
    J[72] += -1 * dqdci;          /* dwdot[HO2]/d[O2] */
    /* d()/d[HO2] */
    dqdci =  + k_f*sc[1];
    J[132] += 1 * dqdci;          /* dwdot[H2]/d[HO2] */
    J[133] += -1 * dqdci;         /* dwdot[H]/d[HO2] */
    J[135] += 1 * dqdci;          /* dwdot[O2]/d[HO2] */
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    /* d()/dT */
    ...
    /* reverse */
    phi_r = sc[9];
    Kc = refCinv * exp((g_RT[7] + g_RT[1]) - (g_RT[9]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[1]) + (h_RT[9]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    Corr = fPr * F;
    ...
    if (consP) {
        ...
        dqdci =  1*dcdc_fac;
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[7] += -1 * dqdci;           /* dwdot[CH2]/d[H2] */
        J[9] += 1 * dqdci;            /* dwdot[CH3]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[7];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[29] += -1 * dqdci;          /* dwdot[CH2]/d[H] */
        ...
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[117] += -1 * dqdci;         /* dwdot[CH2]/d[H2O] */
        J[119] += 1 * dqdci;          /* dwdot[CH3]/d[H2O] */
        /* d()/d[CH2] */
        dqdci =  + k_f*sc[1];
        J[155] += -1 * dqdci;         /* dwdot[H]/d[CH2] */
        J[161] += -1 * dqdci;         /* dwdot[CH2]/d[CH2] */
        J[163] += 1 * dqdci;          /* dwdot[CH3]/d[CH2] */
        /* d()/d[CH3] */
        dqdci =  - k_r;
        J[199] += -1 * dqdci;         /* dwdot[H]/d[CH3] */
        J[205] += -1 * dqdci;         /* dwdot[CH2]/d[CH3] */
        J[207] += 1 * dqdci;          /* dwdot[CH3]/d[CH3] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[227] += -1 * dqdci;         /* dwdot[CH2]/d[CH4] */
        J[229] += 1 * dqdci;          /* dwdot[CH3]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*dcdc_fac;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[249] += -1 * dqdci;         /* dwdot[CH2]/d[CO] */
        J[251] += 1 * dqdci;          /* dwdot[CH3]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[271] += -1 * dqdci;         /* dwdot[CH2]/d[CO2] */
        J[273] += 1 * dqdci;          /* dwdot[CH3]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  2*dcdc_fac;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[403] += -1 * dqdci;         /* dwdot[CH2]/d[C2H6] */
        J[405] += 1 * dqdci;          /* dwdot[CH3]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.3*dcdc_fac;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[447] += -1 * dqdci;         /* dwdot[CH2]/d[AR] */
        J[449] += 1 * dqdci;          /* dwdot[CH3]/d[AR] */
    }
    else {
        dqdc[0] =  2*dcdc_fac;
        dqdc[1] =  1*dcdc_fac + k_f*sc[7];
        dqdc[2] =  1*dcdc_fac;
        dqdc[3] =  1*dcdc_fac;
        dqdc[4] =  1*dcdc_fac;
        dqdc[5] =  6*dcdc_fac;
        dqdc[6] =  1*dcdc_fac;
        dqdc[7] =  1*dcdc_fac + k_f*sc[1];
        dqdc[8] =  1*dcdc_fac;
    ...
    /* reverse */
    phi_r = sc[10];
    Kc = refCinv * exp((g_RT[9] + g_RT[1]) - (g_RT[10]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[1]) + (h_RT[10]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    Corr = fPr * F;
    ...
    if (consP) {
        ...
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[9] += -1 * dqdci;           /* dwdot[CH3]/d[H2] */
        J[10] += 1 * dqdci;           /* dwdot[CH4]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[9];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[31] += -1 * dqdci;          /* dwdot[CH3]/d[H] */
        J[32] += 1 * dqdci;           /* dwdot[CH4]/d[H] */
        /* d()/d[H2O] */
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[119] += -1 * dqdci;         /* dwdot[CH3]/d[H2O] */
        J[120] += 1 * dqdci;          /* dwdot[CH4]/d[H2O] */
        /* d()/d[CH3] */
        dqdci =  + k_f*sc[1];
        J[199] += -1 * dqdci;         /* dwdot[H]/d[CH3] */
        J[207] += -1 * dqdci;         /* dwdot[CH3]/d[CH3] */
        ...
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[251] += -1 * dqdci;         /* dwdot[CH3]/d[CO] */
        J[252] += 1 * dqdci;          /* dwdot[CH4]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[273] += -1 * dqdci;         /* dwdot[CH3]/d[CO2] */
        J[274] += 1 * dqdci;          /* dwdot[CH4]/d[CO2] */
        /* d()/d[C2H6] */
        dqdci =  2*dcdc_fac;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[405] += -1 * dqdci;         /* dwdot[CH3]/d[C2H6] */
        J[406] += 1 * dqdci;          /* dwdot[CH4]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.3*dcdc_fac;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[449] += -1 * dqdci;         /* dwdot[CH3]/d[AR] */
        J[450] += 1 * dqdci;          /* dwdot[CH4]/d[AR] */
    }
    else {
        dqdc[0] =  2*dcdc_fac;
        dqdc[1] =  1*dcdc_fac + k_f*sc[9];
        dqdc[2] =  1*dcdc_fac;
        dqdc[3] =  1*dcdc_fac;
        dqdc[4] =  1*dcdc_fac;
        dqdc[5] =  6*dcdc_fac;
    ...
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[10] + h_RT[1]) + (h_RT[9] + h_RT[0]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    if (consP) {
        ...
        dqdci =  1*dcdc_fac;
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[13] += -1 * dqdci;          /* dwdot[HCO]/d[H2] */
        J[14] += 1 * dqdci;           /* dwdot[CH2O]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[13];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[35] += -1 * dqdci;          /* dwdot[HCO]/d[H] */
        ...
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[123] += -1 * dqdci;         /* dwdot[HCO]/d[H2O] */
        J[124] += 1 * dqdci;          /* dwdot[CH2O]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[233] += -1 * dqdci;         /* dwdot[HCO]/d[CH4] */
        J[234] += 1 * dqdci;          /* dwdot[CH2O]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*dcdc_fac;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[255] += -1 * dqdci;         /* dwdot[HCO]/d[CO] */
        J[256] += 1 * dqdci;          /* dwdot[CH2O]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[277] += -1 * dqdci;         /* dwdot[HCO]/d[CO2] */
        J[278] += 1 * dqdci;          /* dwdot[CH2O]/d[CO2] */
        /* d()/d[HCO] */
        dqdci =  + k_f*sc[1];
        J[287] += -1 * dqdci;         /* dwdot[H]/d[HCO] */
        J[299] += -1 * dqdci;         /* dwdot[HCO]/d[HCO] */
        ...
        dqdci =  2*dcdc_fac;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[409] += -1 * dqdci;         /* dwdot[HCO]/d[C2H6] */
        J[410] += 1 * dqdci;          /* dwdot[CH2O]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.3*dcdc_fac;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[453] += -1 * dqdci;         /* dwdot[HCO]/d[AR] */
        J[454] += 1 * dqdci;          /* dwdot[CH2O]/d[AR] */
    }
    else {
        dqdc[0] =  2*dcdc_fac;
        dqdc[1] =  1*dcdc_fac + k_f*sc[13];
        dqdc[2] =  1*dcdc_fac;
        dqdc[3] =  1*dcdc_fac;
        dqdc[4] =  1*dcdc_fac;
        dqdc[5] =  6*dcdc_fac;
        ...
        dqdc[11] =  1.5*dcdc_fac;
        dqdc[12] =  2*dcdc_fac;
        dqdc[13] =  1*dcdc_fac + k_f*sc[1];
        dqdc[14] =  1*dcdc_fac - k_r;
        dqdc[15] =  1*dcdc_fac;
        dqdc[16] =  1*dcdc_fac;
        dqdc[17] =  1*dcdc_fac;
        dqdc[18] =  3*dcdc_fac;
    ...
    /* reverse */
    phi_r = sc[11]*sc[0];
    Kc = exp((g_RT[1] + g_RT[13]) - (g_RT[11] + g_RT[0]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[1] + h_RT[13]) + (h_RT[11] + h_RT[0]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[22] += 1 * dqdci;           /* dwdot[H2]/d[H] */
    J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
    J[33] += 1 * dqdci;           /* dwdot[CO]/d[H] */
    J[35] += -1 * dqdci;          /* dwdot[HCO]/d[H] */
    /* d()/d[CO] */
    dqdci =  - k_r*sc[0];
    J[242] += 1 * dqdci;          /* dwdot[H2]/d[CO] */
    J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
    J[253] += 1 * dqdci;          /* dwdot[CO]/d[CO] */
    J[255] += -1 * dqdci;         /* dwdot[HCO]/d[CO] */
    /* d()/d[HCO] */
    dqdci =  + k_f*sc[1];
    J[286] += 1 * dqdci;          /* dwdot[H2]/d[HCO] */
    J[287] += -1 * dqdci;         /* dwdot[H]/d[HCO] */
    J[297] += 1 * dqdci;          /* dwdot[CO]/d[HCO] */
    J[299] += -1 * dqdci;         /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    ...
    /* reverse */
    phi_r = sc[15];
    Kc = refCinv * exp((g_RT[14] + g_RT[1]) - (g_RT[15]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[1]) + (h_RT[15]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    Corr = fPr * F;
    ...
    if (consP) {
        ...
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[14] += -1 * dqdci;          /* dwdot[CH2O]/d[H2] */
        J[15] += 1 * dqdci;           /* dwdot[CH3O]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[14];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[36] += -1 * dqdci;          /* dwdot[CH2O]/d[H] */
        J[37] += 1 * dqdci;           /* dwdot[CH3O]/d[H] */
        /* d()/d[H2O] */
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[124] += -1 * dqdci;         /* dwdot[CH2O]/d[H2O] */
        J[125] += 1 * dqdci;          /* dwdot[CH3O]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[234] += -1 * dqdci;         /* dwdot[CH2O]/d[CH4] */
        J[235] += 1 * dqdci;          /* dwdot[CH3O]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*dcdc_fac;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[256] += -1 * dqdci;         /* dwdot[CH2O]/d[CO] */
        J[257] += 1 * dqdci;          /* dwdot[CH3O]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[278] += -1 * dqdci;         /* dwdot[CH2O]/d[CO2] */
        J[279] += 1 * dqdci;          /* dwdot[CH3O]/d[CO2] */
        /* d()/d[CH2O] */
        dqdci =  + k_f*sc[1];
        J[309] += -1 * dqdci;         /* dwdot[H]/d[CH2O] */
        J[322] += -1 * dqdci;         /* dwdot[CH2O]/d[CH2O] */
        J[323] += 1 * dqdci;          /* dwdot[CH3O]/d[CH2O] */
        /* d()/d[CH3O] */
        dqdci =  - k_r;
        J[331] += -1 * dqdci;         /* dwdot[H]/d[CH3O] */
        J[344] += -1 * dqdci;         /* dwdot[CH2O]/d[CH3O] */
        J[345] += 1 * dqdci;          /* dwdot[CH3O]/d[CH3O] */
        /* d()/d[C2H6] */
        dqdci =  2*dcdc_fac;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[410] += -1 * dqdci;         /* dwdot[CH2O]/d[C2H6] */
        J[411] += 1 * dqdci;          /* dwdot[CH3O]/d[C2H6] */
    }
    else {
        dqdc[0] =  2*dcdc_fac;
    ...
    /* reverse */
    phi_r = sc[0]*sc[13];
    Kc = exp((g_RT[14] + g_RT[1]) - (g_RT[0] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[1]) + (h_RT[0] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[9]*sc[4];
    Kc = exp((g_RT[15] + g_RT[1]) - (g_RT[9] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[15] + h_RT[1]) + (h_RT[9] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[92] += 1 * dqdci;           /* dwdot[OH]/d[OH] */
    J[97] += 1 * dqdci;           /* dwdot[CH3]/d[OH] */
    J[103] += -1 * dqdci;         /* dwdot[CH3O]/d[OH] */
    /* d()/d[CH3] */
    dqdci =  - k_r*sc[4];
    J[199] += -1 * dqdci;         /* dwdot[H]/d[CH3] */
    J[202] += 1 * dqdci;          /* dwdot[OH]/d[CH3] */
    J[207] += 1 * dqdci;          /* dwdot[CH3]/d[CH3] */
    J[213] += -1 * dqdci;         /* dwdot[CH3O]/d[CH3] */
    /* d()/d[CH3O] */
    dqdci =  + k_f*sc[1];
    J[331] += -1 * dqdci;         /* dwdot[H]/d[CH3O] */
    J[334] += 1 * dqdci;          /* dwdot[OH]/d[CH3O] */
    J[339] += 1 * dqdci;          /* dwdot[CH3]/d[CH3O] */
    J[345] += -1 * dqdci;         /* dwdot[CH3O]/d[CH3O] */
    /* d()/dT */
    J[463] += -1 * dqdT;          /* dwdot[H]/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[17];
    Kc = refCinv * exp((g_RT[16] + g_RT[1]) - (g_RT[17]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[16] + h_RT[1]) + (h_RT[17]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    Corr = fPr * F;
    ...
    if (consP) {
        ...
        dqdci =  1*dcdc_fac;
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[16] += -1 * dqdci;          /* dwdot[C2H4]/d[H2] */
        J[17] += 1 * dqdci;           /* dwdot[C2H5]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[16];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[38] += -1 * dqdci;          /* dwdot[C2H4]/d[H] */
        J[39] += 1 * dqdci;           /* dwdot[C2H5]/d[H] */
        /* d()/d[H2O] */
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[126] += -1 * dqdci;         /* dwdot[C2H4]/d[H2O] */
        J[127] += 1 * dqdci;          /* dwdot[C2H5]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[236] += -1 * dqdci;         /* dwdot[C2H4]/d[CH4] */
        J[237] += 1 * dqdci;          /* dwdot[C2H5]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*dcdc_fac;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[258] += -1 * dqdci;         /* dwdot[C2H4]/d[CO] */
        J[259] += 1 * dqdci;          /* dwdot[C2H5]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[280] += -1 * dqdci;         /* dwdot[C2H4]/d[CO2] */
        J[281] += 1 * dqdci;          /* dwdot[C2H5]/d[CO2] */
        /* d()/d[C2H4] */
        dqdci =  + k_f*sc[1];
        J[353] += -1 * dqdci;         /* dwdot[H]/d[C2H4] */
        J[368] += -1 * dqdci;         /* dwdot[C2H4]/d[C2H4] */
        J[369] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H4] */
        /* d()/d[C2H5] */
        dqdci =  - k_r;
        J[375] += -1 * dqdci;         /* dwdot[H]/d[C2H5] */
        J[390] += -1 * dqdci;         /* dwdot[C2H4]/d[C2H5] */
        J[391] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H5] */
        /* d()/d[C2H6] */
        dqdci =  2*dcdc_fac;
        J[397] += -1 * dqdci;         /* dwdot[H]/d[C2H6] */
        J[412] += -1 * dqdci;         /* dwdot[C2H4]/d[C2H6] */
        J[413] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H6] */
        /* d()/d[AR] */
        dqdci =  -0.3*dcdc_fac;
        J[441] += -1 * dqdci;         /* dwdot[H]/d[AR] */
        J[456] += -1 * dqdci;         /* dwdot[C2H4]/d[AR] */
        J[457] += 1 * dqdci;          /* dwdot[C2H5]/d[AR] */
    }
    else {
        dqdc[0] =  2*dcdc_fac;
    ...
    if (consP) {
        ...
        J[1] += -1 * dqdci;           /* dwdot[H]/d[H2] */
        J[17] += -1 * dqdci;          /* dwdot[C2H5]/d[H2] */
        J[18] += 1 * dqdci;           /* dwdot[C2H6]/d[H2] */
        /* d()/d[H] */
        dqdci =  + k_f*sc[17];
        J[23] += -1 * dqdci;          /* dwdot[H]/d[H] */
        J[39] += -1 * dqdci;          /* dwdot[C2H5]/d[H] */
        J[40] += 1 * dqdci;           /* dwdot[C2H6]/d[H] */
        /* d()/d[H2O] */
        dqdci =  5*dcdc_fac;
        J[111] += -1 * dqdci;         /* dwdot[H]/d[H2O] */
        J[127] += -1 * dqdci;         /* dwdot[C2H5]/d[H2O] */
        J[128] += 1 * dqdci;          /* dwdot[C2H6]/d[H2O] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[221] += -1 * dqdci;         /* dwdot[H]/d[CH4] */
        J[237] += -1 * dqdci;         /* dwdot[C2H5]/d[CH4] */
        J[238] += 1 * dqdci;          /* dwdot[C2H6]/d[CH4] */
        /* d()/d[CO] */
        dqdci =  0.5*dcdc_fac;
        J[243] += -1 * dqdci;         /* dwdot[H]/d[CO] */
        J[259] += -1 * dqdci;         /* dwdot[C2H5]/d[CO] */
        J[260] += 1 * dqdci;          /* dwdot[C2H6]/d[CO] */
        /* d()/d[CO2] */
        dqdci =  1*dcdc_fac;
        J[265] += -1 * dqdci;         /* dwdot[H]/d[CO2] */
        J[281] += -1 * dqdci;         /* dwdot[C2H5]/d[CO2] */
        J[282] += 1 * dqdci;          /* dwdot[C2H6]/d[CO2] */
        /* d()/d[C2H5] */
        dqdci =  + k_f*sc[1];
        J[375] += -1 * dqdci;         /* dwdot[H]/d[C2H5] */
        J[391] += -1 * dqdci;         /* dwdot[C2H5]/d[C2H5] */
    ...
    /* reverse */
    phi_r = sc[14];
    Kc = refCinv * exp((g_RT[11] + g_RT[0]) - (g_RT[14]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[11] + h_RT[0]) + (h_RT[14]) + 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    Corr = fPr * F;
    ...
    /* reverse */
    phi_r = sc[14]*sc[1];
    Kc = exp((g_RT[7] + g_RT[4]) - (g_RT[14] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[4]) + (h_RT[14] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[89] += 1 * dqdci;           /* dwdot[H]/d[OH] */
    J[92] += -1 * dqdci;          /* dwdot[OH]/d[OH] */
    J[95] += -1 * dqdci;          /* dwdot[CH2]/d[OH] */
    J[102] += 1 * dqdci;          /* dwdot[CH2O]/d[OH] */
    /* d()/d[CH2] */
    dqdci =  + k_f*sc[4];
    J[155] += 1 * dqdci;          /* dwdot[H]/d[CH2] */
    J[158] += -1 * dqdci;         /* dwdot[OH]/d[CH2] */
    J[161] += -1 * dqdci;         /* dwdot[CH2]/d[CH2] */
    J[168] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2] */
    /* d()/d[CH2O] */
    dqdci =  - k_r*sc[1];
    J[309] += 1 * dqdci;          /* dwdot[H]/d[CH2O] */
    J[312] += -1 * dqdci;         /* dwdot[OH]/d[CH2O] */
    J[315] += -1 * dqdci;         /* dwdot[CH2]/d[CH2O] */
    J[322] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    ...
    J[89] += 1 * dqdci;           /* dwdot[H]/d[OH] */
    J[92] += -1 * dqdci;          /* dwdot[OH]/d[OH] */
    J[96] += -1 * dqdci;          /* dwdot[CH2(S)]/d[OH] */
    J[102] += 1 * dqdci;          /* dwdot[CH2O]/d[OH] */
    /* d()/d[CH2(S)] */
    dqdci =  + k_f*sc[4];
    J[177] += 1 * dqdci;          /* dwdot[H]/d[CH2(S)] */
    J[180] += -1 * dqdci;         /* dwdot[OH]/d[CH2(S)] */
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[190] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2(S)] */
    /* d()/d[CH2O] */
    dqdci =  - k_r*sc[1];
    J[309] += 1 * dqdci;          /* dwdot[H]/d[CH2O] */
    J[312] += -1 * dqdci;         /* dwdot[OH]/d[CH2O] */
    J[316] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2O] */
    J[322] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[7]*sc[5];
    Kc = exp((g_RT[9] + g_RT[4]) - (g_RT[7] + g_RT[5]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[4]) + (h_RT[7] + h_RT[5]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  - k_r*sc[5];
    J[158] += -1 * dqdci;         /* dwdot[OH]/d[CH2] */
    J[159] += 1 * dqdci;          /* dwdot[H2O]/d[CH2] */
    J[161] += 1 * dqdci;          /* dwdot[CH2]/d[CH2] */
    J[163] += -1 * dqdci;         /* dwdot[CH3]/d[CH2] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[4];
    J[202] += -1 * dqdci;         /* dwdot[OH]/d[CH3] */
    J[203] += 1 * dqdci;          /* dwdot[H2O]/d[CH3] */
    J[205] += 1 * dqdci;          /* dwdot[CH2]/d[CH3] */
    J[207] += -1 * dqdci;         /* dwdot[CH3]/d[CH3] */
    /* d()/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    ...
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[4]) + (h_RT[8] + h_RT[5]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[114] += -1 * dqdci;         /* dwdot[OH]/d[H2O] */
    J[115] += 1 * dqdci;          /* dwdot[H2O]/d[H2O] */
    J[118] += 1 * dqdci;          /* dwdot[CH2(S)]/d[H2O] */
    J[119] += -1 * dqdci;         /* dwdot[CH3]/d[H2O] */
    /* d()/d[CH2(S)] */
    dqdci =  - k_r*sc[5];
    J[180] += -1 * dqdci;         /* dwdot[OH]/d[CH2(S)] */
    J[181] += 1 * dqdci;          /* dwdot[H2O]/d[CH2(S)] */
    J[184] += 1 * dqdci;          /* dwdot[CH2(S)]/d[CH2(S)] */
    J[185] += -1 * dqdci;         /* dwdot[CH3]/d[CH2(S)] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[4];
    J[202] += -1 * dqdci;         /* dwdot[OH]/d[CH3] */
    J[203] += 1 * dqdci;          /* dwdot[H2O]/d[CH3] */
    J[206] += 1 * dqdci;          /* dwdot[CH2(S)]/d[CH3] */
    J[207] += -1 * dqdci;         /* dwdot[CH3]/d[CH3] */
    /* d()/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    J[467] += 1 * dqdT;           /* dwdot[H2O]/dT */
    ...
    /* reverse */
    phi_r = sc[12]*sc[1];
    Kc = exp((g_RT[11] + g_RT[4]) - (g_RT[12] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[11] + h_RT[4]) + (h_RT[12] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[11]*sc[5];
    Kc = exp((g_RT[13] + g_RT[4]) - (g_RT[11] + g_RT[5]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[13] + h_RT[4]) + (h_RT[11] + h_RT[5]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  - k_r*sc[5];
    J[246] += -1 * dqdci;         /* dwdot[OH]/d[CO] */
    J[247] += 1 * dqdci;          /* dwdot[H2O]/d[CO] */
    J[253] += 1 * dqdci;          /* dwdot[CO]/d[CO] */
    J[255] += -1 * dqdci;         /* dwdot[HCO]/d[CO] */
    /* d()/d[HCO] */
    dqdci =  + k_f*sc[4];
    J[290] += -1 * dqdci;         /* dwdot[OH]/d[HCO] */
    J[291] += 1 * dqdci;          /* dwdot[H2O]/d[HCO] */
    J[297] += 1 * dqdci;          /* dwdot[CO]/d[HCO] */
    J[299] += -1 * dqdci;         /* dwdot[HCO]/d[HCO] */
    /* d()/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[5]*sc[13];
    Kc = exp((g_RT[14] + g_RT[4]) - (g_RT[5] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[4]) + (h_RT[5] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  + k_f*sc[4];
    J[312] += -1 * dqdci;         /* dwdot[OH]/d[CH2O] */
    J[313] += 1 * dqdci;          /* dwdot[H2O]/d[CH2O] */
    J[321] += 1 * dqdci;          /* dwdot[HCO]/d[CH2O] */
    J[322] += -1 * dqdci;         /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[466] += -1 * dqdT;          /* dwdot[OH]/dT */
    ...
    dqdci =  - k_r*sc[5];
    J[378] += -1 * dqdci;         /* dwdot[OH]/d[C2H5] */
    J[379] += 1 * dqdci;          /* dwdot[H2O]/d[C2H5] */
    J[391] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H5] */
    J[392] += -1 * dqdci;         /* dwdot[C2H6]/d[C2H5] */
    /* d()/d[C2H6] */
    dqdci =  + k_f*sc[4];
    ...
    /* reverse */
    phi_r = sc[14]*sc[4];
    Kc = exp((g_RT[7] + g_RT[6]) - (g_RT[14] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[6]) + (h_RT[14] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[136] += 1 * dqdci;          /* dwdot[OH]/d[HO2] */
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    J[139] += -1 * dqdci;         /* dwdot[CH2]/d[HO2] */
    J[146] += 1 * dqdci;          /* dwdot[CH2O]/d[HO2] */
    /* d()/d[CH2] */
    dqdci =  + k_f*sc[6];
    J[158] += 1 * dqdci;          /* dwdot[OH]/d[CH2] */
    J[160] += -1 * dqdci;         /* dwdot[HO2]/d[CH2] */
    J[161] += -1 * dqdci;         /* dwdot[CH2]/d[CH2] */
    J[168] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2] */
    /* d()/d[CH2O] */
    dqdci =  - k_r*sc[4];
    ...
    /* reverse */
    phi_r = sc[10]*sc[3];
    Kc = exp((g_RT[9] + g_RT[6]) - (g_RT[10] + g_RT[3]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[6]) + (h_RT[10] + h_RT[3]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[69] += 1 * dqdci;           /* dwdot[O2]/d[O2] */
    J[72] += -1 * dqdci;          /* dwdot[HO2]/d[O2] */
    J[75] += -1 * dqdci;          /* dwdot[CH3]/d[O2] */
    J[76] += 1 * dqdci;           /* dwdot[CH4]/d[O2] */
    /* d()/d[HO2] */
    dqdci =  + k_f*sc[9];
    J[135] += 1 * dqdci;          /* dwdot[O2]/d[HO2] */
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    J[141] += -1 * dqdci;         /* dwdot[CH3]/d[HO2] */
    J[142] += 1 * dqdci;          /* dwdot[CH4]/d[HO2] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[6];
    J[201] += 1 * dqdci;          /* dwdot[O2]/d[CH3] */
    J[204] += -1 * dqdci;         /* dwdot[HO2]/d[CH3] */
    J[207] += -1 * dqdci;         /* dwdot[CH3]/d[CH3] */
    J[208] += 1 * dqdci;          /* dwdot[CH4]/d[CH3] */
    /* d()/d[CH4] */
    dqdci =  - k_r*sc[3];
    J[223] += 1 * dqdci;          /* dwdot[O2]/d[CH4] */
    J[226] += -1 * dqdci;         /* dwdot[HO2]/d[CH4] */
    J[229] += -1 * dqdci;         /* dwdot[CH3]/d[CH4] */
    J[230] += 1 * dqdci;          /* dwdot[CH4]/d[CH4] */
    /* d()/dT */
    J[465] += 1 * dqdT;           /* dwdot[O2]/dT */
    ...
    /* reverse */
    phi_r = sc[15]*sc[4];
    Kc = exp((g_RT[9] + g_RT[6]) - (g_RT[15] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[6]) + (h_RT[15] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    J[141] += -1 * dqdci;         /* dwdot[CH3]/d[HO2] */
    J[147] += 1 * dqdci;          /* dwdot[CH3O]/d[HO2] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[6];
    J[202] += 1 * dqdci;          /* dwdot[OH]/d[CH3] */
    J[204] += -1 * dqdci;         /* dwdot[HO2]/d[CH3] */
    ...
    dqdci =  - k_r*sc[4];
    J[334] += 1 * dqdci;          /* dwdot[OH]/d[CH3O] */
    J[336] += -1 * dqdci;         /* dwdot[HO2]/d[CH3O] */
    J[339] += -1 * dqdci;         /* dwdot[CH3]/d[CH3O] */
    J[345] += 1 * dqdci;          /* dwdot[CH3O]/d[CH3O] */
    /* d()/dT */
    J[466] += 1 * dqdT;           /* dwdot[OH]/dT */
    ...
    /* reverse */
    phi_r = sc[12]*sc[4];
    Kc = exp((g_RT[11] + g_RT[6]) - (g_RT[12] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[11] + h_RT[6]) + (h_RT[12] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[136] += 1 * dqdci;          /* dwdot[OH]/d[HO2] */
    J[138] += -1 * dqdci;         /* dwdot[HO2]/d[HO2] */
    J[143] += -1 * dqdci;         /* dwdot[CO]/d[HO2] */
    J[144] += 1 * dqdci;          /* dwdot[CO2]/d[HO2] */
    /* d()/d[CO] */
    dqdci =  + k_f*sc[6];
    J[246] += 1 * dqdci;          /* dwdot[OH]/d[CO] */
    J[248] += -1 * dqdci;         /* dwdot[HO2]/d[CO] */
    ...
    /* reverse */
    phi_r = sc[13]*sc[4];
    Kc = exp((g_RT[7] + g_RT[3]) - (g_RT[13] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[3]) + (h_RT[13] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[9]*sc[1];
    Kc = exp((g_RT[7] + g_RT[0]) - (g_RT[9] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[0]) + (h_RT[9] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[16]*sc[1];
    Kc = exp((g_RT[7] + g_RT[9]) - (g_RT[16] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[7] + h_RT[9]) + (h_RT[16] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[161] += -1 * dqdci;         /* dwdot[CH2]/d[CH2] */
    J[163] += -1 * dqdci;         /* dwdot[CH3]/d[CH2] */
    J[170] += 1 * dqdci;          /* dwdot[C2H4]/d[CH2] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[7];
    J[199] += 1 * dqdci;          /* dwdot[H]/d[CH3] */
    J[205] += -1 * dqdci;         /* dwdot[CH2]/d[CH3] */
    ...
    dqdci =  - k_r*sc[1];
    J[353] += 1 * dqdci;          /* dwdot[H]/d[C2H4] */
    J[359] += -1 * dqdci;         /* dwdot[CH2]/d[C2H4] */
    J[361] += -1 * dqdci;         /* dwdot[CH3]/d[C2H4] */
    J[368] += 1 * dqdci;          /* dwdot[C2H4]/d[C2H4] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    ...
    dqdci =  - k_r*sc[19];
    J[161] += 1 * dqdci;          /* dwdot[CH2]/d[CH2] */
    J[162] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2] */
    /* d()/d[CH2(S)] */
    dqdci =  + k_f*sc[19];
    J[183] += 1 * dqdci;          /* dwdot[CH2]/d[CH2(S)] */
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    /* d()/d[N2] */
    dqdci =  + k_f*sc[8] - k_r*sc[7];
    J[425] += 1 * dqdci;          /* dwdot[CH2]/d[N2] */
    J[426] += -1 * dqdci;         /* dwdot[CH2(S)]/d[N2] */
    /* d()/dT */
    J[469] += 1 * dqdT;           /* dwdot[CH2]/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    ...
    /* reverse */
    phi_r = sc[20]*sc[7];
    Kc = exp((g_RT[20] + g_RT[8]) - (g_RT[20] + g_RT[7]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[20] + h_RT[8]) + (h_RT[20] + h_RT[7]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  + k_f*sc[8] - k_r*sc[7];
    J[447] += 1 * dqdci;          /* dwdot[CH2]/d[AR] */
    J[448] += -1 * dqdci;         /* dwdot[CH2(S)]/d[AR] */
    /* d()/dT */
    J[469] += 1 * dqdT;           /* dwdot[CH2]/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    ...
    dlnkfdT = 0.0;
    /* reverse */
    phi_r = sc[11]*sc[1]*sc[4];
    Kc = refC * exp((g_RT[8] + g_RT[3]) - (g_RT[11] + g_RT[1] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[3]) + (h_RT[11] + h_RT[1] + h_RT[4]) - 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  + k_f*sc[3];
    J[177] += 1 * dqdci;          /* dwdot[H]/d[CH2(S)] */
    J[179] += -1 * dqdci;         /* dwdot[O2]/d[CH2(S)] */
    J[180] += 1 * dqdci;          /* dwdot[OH]/d[CH2(S)] */
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[187] += 1 * dqdci;          /* dwdot[CO]/d[CH2(S)] */
    /* d()/d[CO] */
    dqdci =  - k_r*sc[1]*sc[4];
    J[243] += 1 * dqdci;          /* dwdot[H]/d[CO] */
    J[245] += -1 * dqdci;         /* dwdot[O2]/d[CO] */
    J[246] += 1 * dqdci;          /* dwdot[OH]/d[CO] */
    J[250] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CO] */
    J[253] += 1 * dqdci;          /* dwdot[CO]/d[CO] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    J[465] += -1 * dqdT;          /* dwdot[O2]/dT */
    ...
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[3]) + (h_RT[11] + h_RT[5]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[0]) + (h_RT[9] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* d()/d[CH2(S)] */
    dqdci =  + k_f*sc[0];
    J[176] += -1 * dqdci;         /* dwdot[H2]/d[CH2(S)] */
    J[177] += 1 * dqdci;          /* dwdot[H]/d[CH2(S)] */
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[185] += 1 * dqdci;          /* dwdot[CH3]/d[CH2(S)] */
    /* d()/d[CH3] */
    ...
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[5]) + (h_RT[7] + h_RT[5]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[16]*sc[1];
    Kc = exp((g_RT[8] + g_RT[9]) - (g_RT[16] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[9]) + (h_RT[16] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[185] += -1 * dqdci;         /* dwdot[CH3]/d[CH2(S)] */
    J[192] += 1 * dqdci;          /* dwdot[C2H4]/d[CH2(S)] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[8];
    J[199] += 1 * dqdci;          /* dwdot[H]/d[CH3] */
    J[206] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH3] */
    ...
    dqdci =  - k_r*sc[1];
    J[353] += 1 * dqdci;          /* dwdot[H]/d[C2H4] */
    J[360] += -1 * dqdci;         /* dwdot[CH2(S)]/d[C2H4] */
    J[361] += -1 * dqdci;         /* dwdot[CH3]/d[C2H4] */
    J[368] += 1 * dqdci;          /* dwdot[C2H4]/d[C2H4] */
    /* d()/dT */
    J[463] += 1 * dqdT;           /* dwdot[H]/dT */
    ...
    J[186] += -1 * dqdci;         /* dwdot[CH4]/d[CH2(S)] */
    /* d()/d[CH3] */
    dqdci =  - k_r*2*sc[9];
    J[206] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH3] */
    J[207] += 2 * dqdci;          /* dwdot[CH3]/d[CH3] */
    ...
    /* d()/d[CH4] */
    dqdci =  + k_f*sc[8];
    J[228] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH4] */
    J[229] += 2 * dqdci;          /* dwdot[CH3]/d[CH4] */
    J[230] += -1 * dqdci;         /* dwdot[CH4]/d[CH4] */
    /* d()/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    ...
    dqdci =  + k_f*sc[8] - k_r*sc[7];
    J[271] += 1 * dqdci;          /* dwdot[CH2]/d[CO2] */
    J[272] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CO2] */
    /* d()/dT */
    J[469] += 1 * dqdT;           /* dwdot[CH2]/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    ...
    /* reverse */
    phi_r = sc[14]*sc[11];
    Kc = exp((g_RT[8] + g_RT[12]) - (g_RT[14] + g_RT[11]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[8] + h_RT[12]) + (h_RT[14] + h_RT[11]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[184] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2(S)] */
    J[187] += 1 * dqdci;          /* dwdot[CO]/d[CH2(S)] */
    J[188] += -1 * dqdci;         /* dwdot[CO2]/d[CH2(S)] */
    J[190] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2(S)] */
    /* d()/d[CO] */
    dqdci =  - k_r*sc[14];
    J[250] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CO] */
    ...
    J[316] += -1 * dqdci;         /* dwdot[CH2(S)]/d[CH2O] */
    J[319] += 1 * dqdci;          /* dwdot[CO]/d[CH2O] */
    J[320] += -1 * dqdci;         /* dwdot[CO2]/d[CH2O] */
    J[322] += 1 * dqdci;          /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[470] += -1 * dqdT;          /* dwdot[CH2(S)]/dT */
    J[473] += 1 * dqdT;           /* dwdot[CO]/dT */
    ...
    /* reverse */
    phi_r = sc[15]*sc[2];
    Kc = exp((g_RT[9] + g_RT[3]) - (g_RT[15] + g_RT[2]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[3]) + (h_RT[15] + h_RT[2]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[47] += -1 * dqdci;          /* dwdot[O2]/d[O] */
    J[53] += -1 * dqdci;          /* dwdot[CH3]/d[O] */
    J[59] += 1 * dqdci;           /* dwdot[CH3O]/d[O] */
    /* d()/d[O2] */
    dqdci =  + k_f*sc[9];
    J[68] += 1 * dqdci;           /* dwdot[O]/d[O2] */
    J[69] += -1 * dqdci;          /* dwdot[O2]/d[O2] */
    J[75] += -1 * dqdci;          /* dwdot[CH3]/d[O2] */
    J[81] += 1 * dqdci;           /* dwdot[CH3O]/d[O2] */
    /* d()/d[CH3] */
    dqdci =  + k_f*sc[3];
    J[200] += 1 * dqdci;          /* dwdot[O]/d[CH3] */
    J[201] += -1 * dqdci;         /* dwdot[O2]/d[CH3] */
    ...
    /* d()/d[CH3O] */
    dqdci =  - k_r*sc[2];
    J[332] += 1 * dqdci;          /* dwdot[O]/d[CH3O] */
    J[333] += -1 * dqdci;         /* dwdot[O2]/d[CH3O] */
    J[339] += -1 * dqdci;         /* dwdot[CH3]/d[CH3O] */
    J[345] += 1 * dqdci;          /* dwdot[CH3O]/d[CH3O] */
    /* d()/dT */
    J[464] += 1 * dqdT;           /* dwdot[O]/dT */
    ...
    /* reverse */
    phi_r = sc[14]*sc[4];
    Kc = exp((g_RT[9] + g_RT[3]) - (g_RT[14] + g_RT[4]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[9] + h_RT[3]) + (h_RT[14] + h_RT[4]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    if (consP) {
        ...
        dqdci =  + k_f*2*sc[9];
        J[207] += -2 * dqdci;         /* dwdot[CH3]/d[CH3] */
        J[216] += 1 * dqdci;          /* dwdot[C2H6]/d[CH3] */
        /* d()/d[CH4] */
        dqdci =  1*dcdc_fac;
        J[229] += -2 * dqdci;         /* dwdot[CH3]/d[CH4] */
        J[238] += 1 * dqdci;          /* dwdot[C2H6]/d[CH4] */
    ...
    /* reverse */
    phi_r = sc[17]*sc[1];
    Kc = exp((2 * g_RT[9]) - (g_RT[17] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(2*h_RT[9]) + (h_RT[17] + h_RT[1]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    /* reverse */
    phi_r = sc[10]*sc[13];
    Kc = exp((g_RT[14] + g_RT[9]) - (g_RT[10] + g_RT[13]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[14] + h_RT[9]) + (h_RT[10] + h_RT[13]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  + k_f*sc[9];
    J[317] += -1 * dqdci;         /* dwdot[CH3]/d[CH2O] */
    J[318] += 1 * dqdci;          /* dwdot[CH4]/d[CH2O] */
    J[321] += 1 * dqdci;          /* dwdot[HCO]/d[CH2O] */
    J[322] += -1 * dqdci;         /* dwdot[CH2O]/d[CH2O] */
    /* d()/dT */
    J[471] += -1 * dqdT;          /* dwdot[CH3]/dT */
    ...
    /* reverse */
    phi_r = sc[17]*sc[10];
    Kc = exp((g_RT[18] + g_RT[9]) - (g_RT[17] + g_RT[10]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[18] + h_RT[9]) + (h_RT[17] + h_RT[10]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    dqdci =  - k_r*sc[10];
    J[383] += -1 * dqdci;         /* dwdot[CH3]/d[C2H5] */
    J[384] += 1 * dqdci;          /* dwdot[CH4]/d[C2H5] */
    J[391] += 1 * dqdci;          /* dwdot[C2H5]/d[C2H5] */
    J[392] += -1 * dqdci;         /* dwdot[C2H6]/d[C2H5] */
    /* d()/d[C2H6] */
    dqdci =  + k_f*sc[9];
    ...
    /* reverse */
    phi_r = sc[11]*sc[1]*sc[5];
    Kc = refC * exp((g_RT[5] + g_RT[13]) - (g_RT[11] + g_RT[1] + g_RT[5]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[5] + h_RT[13]) + (h_RT[11] + h_RT[1] + h_RT[5]) - 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    wdot[13] -= q; /* HCO */
    /* d()/d[H] */
    dqdci =  - k_r*sc[11]*sc[5];
    J[23] += 1 * dqdci;           /* dwdot[H]/d[H] */
    J[33] += 1 * dqdci;           /* dwdot[CO]/d[H] */
    J[35] += -1 * dqdci;          /* dwdot[HCO]/d[H] */
    /* d()/d[H2O] */
    dqdci =  + k_f*sc[13] - k_r*sc[11]*sc[1];
    J[111] += 1 * dqdci;          /* dwdot[H]/d[H2O] */
    J[121] += 1 * dqdci;          /* dwdot[CO]/d[H2O] */
    J[123] += -1 * dqdci;         /* dwdot[HCO]/d[H2O] */
    /* d()/d[CO] */
    ...
    /* reverse */
    phi_r = sc[11]*sc[1];
    Kc = refC * exp((g_RT[13]) - (g_RT[11] + g_RT[1]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[13]) + (h_RT[11] + h_RT[1]) - 1);
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q_nocor = k_f*phi_f - k_r*phi_r;
    q = alpha * q_nocor;
    ...
    /* reverse */
    phi_r = sc[11]*sc[6];
    Kc = exp((g_RT[13] + g_RT[3]) - (g_RT[11] + g_RT[6]));
    k_r = k_f / Kc;
    dlnKcdT = invT * (-(h_RT[13] + h_RT[3]) + (h_RT[11] + h_RT[6]));
    dkrdT = (dlnkfdT - dlnKcdT)*k_r;
    /* rate of progress */
    q = k_f*phi_f - k_r*phi_r;
    dqdT = (dlnkfdT*k_f*phi_f - dkrdT*phi_r);
    ...
    J[69] += -1 * dqdci;          /* dwdot[O2]/d[O2] */
    J[72] += 1 * dqdci;           /* dwdot[HO2]/d[O2] */
    J[82] += 1 * dqdci;           /* dwdot[C2H4]/d[O2] */
    J[83] += -1 * dqdci;          /* dwdot[C2H5]/d[O2] */
    /* d()/d[HO2] */
    dqdci =  - k_r*sc[16];
    J[135] += -1 * dqdci;         /* dwdot[O2]/d[HO2] */
    J[138] += 1 * dqdci;          /* dwdot[HO2]/d[HO2] */
    J[148] += 1 * dqdci;          /* dwdot[C2H4]/d[HO2] */
    J[149] += -1 * dqdci;         /* dwdot[C2H5]/d[HO2] */
    /* d()/d[C2H4] */
    dqdci =  - k_r*sc[6];
    J[355] += -1 * dqdci;         /* dwdot[O2]/d[C2H4] */
    J[358] += 1 * dqdci;          /* dwdot[HO2]/d[C2H4] */
    J[368] += 1 * dqdci;          /* dwdot[C2H4]/d[C2H4] */
    J[369] += -1 * dqdci;         /* dwdot[C2H5]/d[C2H4] */
    /* d()/d[C2H5] */
    dqdci =  + k_f*sc[3];
    J[377] += -1 * dqdci;         /* dwdot[O2]/d[C2H5] */
    J[380] += 1 * dqdci;          /* dwdot[HO2]/d[C2H5] */
    J[390] += 1 * dqdci;          /* dwdot[C2H4]/d[C2H5] */
    J[391] += -1 * dqdci;         /* dwdot[C2H5]/d[C2H5] */
    /* d()/dT */
    J[465] += -1 * dqdT;          /* dwdot[O2]/dT */
...
void egtransetCOFTD(double* COFTD) {
  ...
  COFTD[          28] =   0.3247471361061310E+00;
  COFTD[          29] =   0.1777985650733727E-03;
  COFTD[          30] =  -0.1089347458861849E-06;
  COFTD[          31] =   0.2035959056112114E-10;
  ...
  COFTD[          36] =   0.3311912921591189E+00;
  COFTD[          37] =   0.1813267307504234E-03;
  COFTD[          38] =  -0.1110964046786237E-06;
  COFTD[          39] =   0.2076359836954698E-10;
  COFTD[          40] =   0.3395573510152542E+00;
  COFTD[          41] =   0.1793350524644130E-03;
  COFTD[          42] =  -0.1101357188562818E-06;
  COFTD[          43] =   0.2064272631295983E-10;
  COFTD[          44] =   0.4306056706094065E+00;
  COFTD[          45] =   0.9359619868800346E-04;
  COFTD[          46] =  -0.6039837349070145E-07;
  COFTD[          47] =   0.1231151900773763E-10;
  COFTD[          48] =   0.2931916398206432E+00;
  COFTD[          49] =   0.4014300382755085E-03;
  COFTD[          50] =  -0.2307057834480938E-06;
  COFTD[          51] =   0.4051766204108762E-10;
  COFTD[          52] =   0.1221198807690243E+00;
  COFTD[          53] =   0.6183736619549319E-03;
  COFTD[          54] =  -0.3284226181678354E-06;
  COFTD[          55] =   0.5446035619319622E-10;
  COFTD[          56] =   0.1226934830045553E+00;
  COFTD[          57] =   0.6212781891511368E-03;
  COFTD[          58] =  -0.3299652330704521E-06;
  COFTD[          59] =   0.5471615878539925E-10;
  COFTD[          60] =   0.1403144190321918E+00;
  COFTD[          61] =   0.6012660048574510E-03;
  COFTD[          62] =  -0.3219150906946780E-06;
  COFTD[          63] =   0.5366790096442973E-10;
  COFTD[          64] =   0.2490175873186386E+00;
  COFTD[          65] =   0.4290366083999712E-03;
  COFTD[          66] =  -0.2426686389852732E-06;
  COFTD[          67] =   0.4208014064702138E-10;
  COFTD[          68] =   0.2727597106400999E+00;
  COFTD[          69] =   0.3944027517533329E-03;
  COFTD[          70] =  -0.2258005402743759E-06;
  COFTD[          71] =   0.3953256687340045E-10;
  COFTD[          72] =   0.2740370684853061E+00;
  COFTD[          73] =   0.3962497747170277E-03;
  COFTD[          74] =  -0.2268579841721363E-06;
  COFTD[          75] =   0.3971770137995339E-10;
  COFTD[          76] =   0.4313313898218810E+00;
  COFTD[          77] =   0.9205368774727828E-04;
  COFTD[          78] =  -0.5945097223307069E-07;
  COFTD[          79] =   0.1214380118036443E-10;
  COFTD[          80] =   0.4010129334861676E+00;
  COFTD[          81] =   0.1972528443628177E-03;
  COFTD[          82] =  -0.1216981610244689E-06;
  COFTD[          83] =   0.2294088734064920E-10;
  COFTD[          84] =   0.1441522353365304E+00;
  COFTD[          85] =   0.7999936505724083E-04;
  COFTD[          86] =  -0.4897074975189896E-07;
  COFTD[          87] =   0.9142773649236618E-11;
  COFTD[          88] =   0.0000000000000000E+00;
  COFTD[          89] =   0.0000000000000000E+00;
  COFTD[          90] =   0.0000000000000000E+00;
  COFTD[          91] =   0.0000000000000000E+00;
  COFTD[          92] =   0.2352832283423578E+00;
  COFTD[          93] =   0.4656706350120388E-03;
  COFTD[          94] =  -0.2609398458577575E-06;
  COFTD[          95] =   0.4492718580048779E-10;
  COFTD[          96] =   0.1798404103253150E+00;
  COFTD[          97] =   0.6017229463172420E-03;
  COFTD[          98] =  -0.3264339193657546E-06;
  COFTD[          99] =   0.5491123423829806E-10;
  COFTD[         100] =   0.2370534621354604E+00;
  COFTD[         101] =   0.4691742672103970E-03;
  COFTD[         102] =  -0.2629031159826994E-06;
  COFTD[         103] =   0.4526521083989819E-10;
  COFTD[         104] =  -0.1743526120296758E+00;
  COFTD[         105] =   0.8622469282596517E-03;
  COFTD[         106] =  -0.3795455129739271E-06;
  COFTD[         107] =   0.5602621271895701E-10;
  COFTD[         108] =   0.1801870770056730E+00;
  COFTD[         109] =   0.6028828485656729E-03;
  COFTD[         110] =  -0.3270631648338786E-06;
  COFTD[         111] =   0.5501708305866783E-10;
  COFTD[         112] =   0.9907533094923988E-01;
  COFTD[         113] =   0.6442014322917300E-03;
  COFTD[         114] =  -0.3384859791884526E-06;
  COFTD[         115] =   0.5573567872490878E-10;
  COFTD[         116] =   0.9907533094923988E-01;
  COFTD[         117] =   0.6442014322917300E-03;
  COFTD[         118] =  -0.3384859791884526E-06;
  COFTD[         119] =   0.5573567872490878E-10;
  COFTD[         120] =   0.1000392102974500E+00;
  COFTD[         121] =   0.6504687084211580E-03;
  COFTD[         122] =  -0.3417790254177462E-06;
  COFTD[         123] =   0.5627791733432544E-10;
  COFTD[         124] =   0.1051242233178346E+00;
  COFTD[         125] =   0.6506660047178345E-03;
  COFTD[         126] =  -0.3425645641009918E-06;
  COFTD[         127] =   0.5648041610405423E-10;
  COFTD[         128] =   0.2001200095273127E+00;
  COFTD[         129] =   0.5647937464189248E-03;
  COFTD[         130] =  -0.3094455087464756E-06;
  COFTD[         131] =   0.5241393748626840E-10;
  COFTD[         132] =  -0.2003084371216687E-01;
  COFTD[         133] =   0.8504401712698103E-03;
  COFTD[         134] =  -0.4210644955951721E-06;
  COFTD[         135] =   0.6679597524516173E-10;
  COFTD[         136] =  -0.1609811732564022E+00;
  COFTD[         137] =   0.9038076297512394E-03;
  COFTD[         138] =  -0.4069279669787991E-06;
  COFTD[         139] =   0.6092022913992956E-10;
  COFTD[         140] =  -0.1613574734420234E+00;
  COFTD[         141] =   0.9059203176635061E-03;
  COFTD[         142] =  -0.4078791780205072E-06;
  COFTD[         143] =   0.6106263270843215E-10;
  COFTD[         144] =  -0.1312444259932660E+00;
  COFTD[         145] =   0.9039014427379127E-03;
  COFTD[         146] =  -0.4178315332949202E-06;
  COFTD[         147] =   0.6357257058426966E-10;
  COFTD[         148] =  -0.5087437787577148E-01;
  COFTD[         149] =   0.8543426436721789E-03;
  COFTD[         150] =  -0.4159264807346257E-06;
  COFTD[         151] =   0.6530633032370990E-10;
  COFTD[         152] =  -0.2716895748891503E-01;
  COFTD[         153] =   0.8372331893523684E-03;
  COFTD[         154] =  -0.4128876639137287E-06;
  COFTD[         155] =   0.6534052395309522E-10;
  COFTD[         156] =  -0.2723227826735267E-01;
  COFTD[         157] =   0.8391844698645221E-03;
  COFTD[         158] =  -0.4138499521537908E-06;
  COFTD[         159] =   0.6549280851690021E-10;
  COFTD[         160] =   0.2015217542366260E+00;
  COFTD[         161] =   0.5627441294507066E-03;
  COFTD[         162] =  -0.3085192624064295E-06;
  COFTD[         163] =   0.5228060239663243E-10;
  COFTD[         164] =   0.1221940303626176E+00;
  COFTD[         165] =   0.6903211781262630E-03;
  COFTD[         166] =  -0.3648449022916740E-06;
  COFTD[         167] =   0.6030549194456049E-10;
};
