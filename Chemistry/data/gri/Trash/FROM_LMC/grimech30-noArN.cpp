...
void productionRate(double * wdot, double * sc, double T)
{
    ...
    if (T != T_save)
    {
        ...
        k_f_save[187] = 1e-06 * 2.92e+12*exp(-909.81573177493316962*invT);
        k_f_save[188] = 1e-06 * 2.92e+12*exp(-909.81573177493316962*invT);
...
C2H4    C2H5    C2H6    HCCO    CH2CO   HCCOH   N2      C3H7	
C3H8    CH2CHO  CH3CHO	
END
!THERMO
