...
void productionRate(double * wdot, double * sc, double T)
{
    ...
    static double logFcent_save[84];
    static double redP_save[84];
    ...
    if (T != T_save)
    {
      ...
      k_f_save[1] = 1e-06 * 50000*exp(2.67*tc[0]-3165.58*Tinv);
      k_f_save[2] = 1e-06 * 2e+13;
      k_f_save[3] = 1e-06 * 8e+13;
      k_f_save[4] = 1e-06 * 1.5e+13;
      k_f_save[5] = 1e-06 * 8.43e+13;
      k_f_save[6] = 1e-06 * 1.02e+09*exp(1.5*tc[0]-4328.13*Tinv);
      k_f_save[7] = 1e-12 * 6.02e+14*exp(-1509.81*Tinv);
      k_f_save[8] = 1e-06 * 3e+13;
      k_f_save[9] = 1e-06 * 3e+13;
      k_f_save[10] = 1e-06 * 3.9e+13*exp(-1781.58*Tinv);
      k_f_save[11] = 1e-06 * 1.92e+07*exp(1.83*tc[0]-110.72*Tinv);
      k_f_save[12] = 1e-06 * 1.32e+14;
      k_f_save[13] = 1e-06 * 8.98e+07*exp(1.92*tc[0]-2863.61*Tinv);
      k_f_save[14] = 1e-06 * 2.5e+12*exp(-24056.4*Tinv);
      k_f_save[15] = 1e-06 * 1e+14*exp(-20130.9*Tinv);
      ...
      k_f_save[21] = 1e-06 * 8.3e+13*exp(-7253.65*Tinv);
      ...
      k_f_save[27] = 1e-06 * 2.8e+13*exp(-537.494*Tinv);
      k_f_save[28] = 1e-06 * 1.34e+14*exp(-319.577*Tinv);
      k_f_save[29] = 1e-06 * 2.5e+16*exp(-0.8*tc[0]);
      k_f_save[30] = 1e-06 * 1.27e+16*exp(-0.63*tc[0]-192.753*Tinv);
      k_f_save[31] = 1e-06 * 6.6e+08*exp(1.62*tc[0]-5455.46*Tinv);
      k_f_save[32] = 1e-06 * 1.09e+12*exp(0.48*tc[0]+130.851*Tinv);
      k_f_save[33] = 1e-06 * 7.34e+13;
      k_f_save[34] = 1e-06 * 5.4e+11*exp(0.454*tc[0]-1308.51*Tinv);
      k_f_save[35] = 1e-06 * 2.3e+10*exp(1.05*tc[0]-1648.21*Tinv);
      k_f_save[36] = 1e-06 * 3.2e+13;
      k_f_save[37] = 1e-06 * 1.08e+12*exp(0.454*tc[0]-915.954*Tinv);
      k_f_save[38] = 1e-06 * 5.21e+17*exp(-0.99*tc[0]-795.169*Tinv);
      k_f_save[39] = 1e-06 * 1.15e+08*exp(1.9*tc[0]-3789.63*Tinv);
      k_f_save[40] = 1e-06 * 4.3e+07*exp(1.5*tc[0]-40060.4*Tinv);
      k_f_save[41] = 1e-06 * 2.16e+08*exp(1.51*tc[0]-1726.22*Tinv);
      k_f_save[42] = 1e-06 * 35700*exp(2.4*tc[0]+1061.9*Tinv);
      k_f_save[43] = 1e-06 * 2.9e+13*exp(+251.636*Tinv);
      k_f_save[44] = 1e-06 * 2e+13;
      k_f_save[45] = 1e-06 * 3e+13;
      k_f_save[46] = 1e-06 * 5.6e+07*exp(1.6*tc[0]-2727.73*Tinv);
      k_f_save[47] = 1e-06 * 2.501e+13;
      k_f_save[48] = 1e-06 * 1e+08*exp(1.6*tc[0]-1570.21*Tinv);
      k_f_save[49] = 1e-06 * 4.76e+07*exp(1.228*tc[0]-35.229*Tinv);
      k_f_save[50] = 1e-06 * 5e+13;
      k_f_save[51] = 1e-06 * 3.43e+09*exp(1.18*tc[0]+224.962*Tinv);
      k_f_save[52] = 1e-06 * 3.54e+06*exp(2.12*tc[0]-437.846*Tinv);
      k_f_save[53] = 1e-06 * 2e+13;
      k_f_save[54] = 1e-06 * 1e+12;
      k_f_save[55] = 1e-06 * 2e+13;
      k_f_save[56] = 1e-06 * 1.5e+14*exp(-11877.2*Tinv);
      k_f_save[57] = 1e-06 * 1.32e+13*exp(-754.907*Tinv);
      k_f_save[58] = 1e-06 * 500000*exp(2*tc[0]-3638.65*Tinv);
      k_f_save[59] = 1e-06 * 4e+13;
      k_f_save[60] = 1e-06 * 2.46e+06*exp(2*tc[0]-4162.05*Tinv);
      k_f_save[61] = 1e-06 * 1.5e+13*exp(-301.963*Tinv);
      k_f_save[62] = 1e-06 * 9e+12*exp(-301.963*Tinv);
      k_f_save[63] = 1e-06 * 2.8e+13;
      k_f_save[64] = 1e-06 * 1.2e+13;
      k_f_save[65] = 1e-06 * 7e+13;
      k_f_save[66] = 1e-06 * 3e+13;
      k_f_save[67] = 1e-06 * 1.2e+13*exp(+286.865*Tinv);
      k_f_save[68] = 1e-06 * 1.6e+13*exp(+286.865*Tinv);
      k_f_save[69] = 1e-06 * 9e+12;
      k_f_save[70] = 1e-06 * 7e+12;
      k_f_save[71] = 1e-06 * 1.4e+13;
      k_f_save[72] = 1e-06 * 2.675e+13*exp(-14494.2*Tinv);
      k_f_save[73] = 1e-06 * 3.6e+10*exp(-4499.25*Tinv);
      k_f_save[74] = 1e-06 * 2.12e+16*exp(-0.97*tc[0]-312.028*Tinv);
      k_f_save[75] = 1e-06 * 4.99e+12*exp(0.1*tc[0]-5334.68*Tinv);
      k_f_save[76] = 1e-06 * 2.648e+13;
      k_f_save[77] = 1e-06 * 3320*exp(2.81*tc[0]-2949.17*Tinv);
      k_f_save[78] = 1e-06 * 6.14e+06*exp(1.74*tc[0]-5259.18*Tinv);
      k_f_save[79] = 1e-06 * 2.244e+18*exp(-1*tc[0]-8555.61*Tinv);
      k_f_save[80] = 1e-06 * 1.87e+17*exp(-1*tc[0]-8555.61*Tinv);
      k_f_save[81] = 1e-06 * 7.6e+12*exp(-201.309*Tinv);
      k_f_save[82] = 1e-06 * 4.28e-13*exp(7.6*tc[0]+1776.55*Tinv);
      k_f_save[83] = 1e-06 * 8.4e+11*exp(-1950.18*Tinv);

      Kc_save[0] = irefC * exp((g_RT[2] + g_RT[1]) - (g_RT[4]));
      ...
      Kc_save[7] = irefC * exp((g_RT[2] + g_RT[11]) - (g_RT[12]));
      ...
      Kc_save[16] = irefC * exp((g_RT[1] + g_RT[3]) - (g_RT[6]));
      Kc_save[17] = irefC * exp((g_RT[1] + 2 * g_RT[3]) - (g_RT[6] + g_RT[3]));
      Kc_save[18] = irefC * exp((g_RT[1] + g_RT[3] + g_RT[5]) - (g_RT[6] + g_RT[5]));
      Kc_save[19] = irefC * exp((g_RT[1] + g_RT[3] + g_RT[19]) - (g_RT[6] + g_RT[19]));
      Kc_save[20] = irefC * exp((g_RT[1] + g_RT[3] + g_RT[20]) - (g_RT[6] + g_RT[20]));
      Kc_save[21] = exp((g_RT[1] + g_RT[3]) - (g_RT[2] + g_RT[4]));
      Kc_save[22] = irefC * exp((2 * g_RT[1]) - (g_RT[0]));
      Kc_save[23] = irefC * exp((2 * g_RT[1] + g_RT[0]) - (2 * g_RT[0]));
      Kc_save[24] = irefC * exp((2 * g_RT[1] + g_RT[5]) - (g_RT[0] + g_RT[5]));
      Kc_save[25] = irefC * exp((2 * g_RT[1] + g_RT[12]) - (g_RT[0] + g_RT[12]));
      Kc_save[26] = irefC * exp((g_RT[1] + g_RT[4]) - (g_RT[5]));
      Kc_save[27] = exp((g_RT[1] + g_RT[6]) - (g_RT[3] + g_RT[0]));
      Kc_save[28] = exp((g_RT[1] + g_RT[6]) - (2 * g_RT[4]));
      Kc_save[29] = irefC * exp((g_RT[1] + g_RT[7]) - (g_RT[9]));
      Kc_save[30] = irefC * exp((g_RT[1] + g_RT[9]) - (g_RT[10]));
      Kc_save[31] = exp((g_RT[1] + g_RT[10]) - (g_RT[9] + g_RT[0]));
      Kc_save[32] = irefC * exp((g_RT[1] + g_RT[13]) - (g_RT[14]));
      Kc_save[33] = exp((g_RT[1] + g_RT[13]) - (g_RT[0] + g_RT[11]));
      Kc_save[34] = irefC * exp((g_RT[1] + g_RT[14]) - (g_RT[15]));
      Kc_save[35] = exp((g_RT[1] + g_RT[14]) - (g_RT[13] + g_RT[0]));
      Kc_save[36] = exp((g_RT[1] + g_RT[15]) - (g_RT[4] + g_RT[9]));
      Kc_save[37] = irefC * exp((g_RT[1] + g_RT[16]) - (g_RT[17]));
      Kc_save[38] = irefC * exp((g_RT[1] + g_RT[17]) - (g_RT[18]));
      Kc_save[39] = exp((g_RT[1] + g_RT[18]) - (g_RT[17] + g_RT[0]));
      Kc_save[40] = irefC * exp((g_RT[0] + g_RT[11]) - (g_RT[14]));
      ...
      Kc_save[74] = irefC * exp((2 * g_RT[9]) - (g_RT[18]));
      ...
      logFcent_save[29] = log10((0.32*exp(T/-78))+ (0.68*exp(T/-1995))+ (exp(-5590*Tinv)));
      logFcent_save[30] = log10((0.217*exp(T/-74))+ (0.783*exp(T/-2941))+ (exp(-6964*Tinv)));
      logFcent_save[32] = log10((0.2176*exp(T/-271))+ (0.7824*exp(T/-2755))+ (exp(-6570*Tinv)));
      logFcent_save[34] = log10((0.242*exp(T/-94))+ (0.758*exp(T/-1555))+ (exp(-4200*Tinv)));
      logFcent_save[37] = log10((0.0247*exp(T/-210))+ (0.9753*exp(T/-984))+ (exp(-4374*Tinv)));
      logFcent_save[38] = log10((0.1578*exp(T/-125))+ (0.8422*exp(T/-2219))+ (exp(-6882*Tinv)));
      logFcent_save[40] = log10((0.068*exp(T/-197))+ (0.932*exp(T/-1540))+ (exp(-10300*Tinv)));
      logFcent_save[74] = log10((0.4675*exp(T/-151))+ (0.5325*exp(T/-1038))+ (exp(-4970*Tinv)));

      redP_save[29] = 1e-12 / k_f_save[29] * 3.2e+27*exp(-3.14*tc[0]-619.024*Tinv);
      redP_save[30] = 1e-12 / k_f_save[30] * 2.477e+33*exp(-4.76*tc[0]-1227.98*Tinv);
      redP_save[32] = 1e-12 / k_f_save[32] * 1.35e+24*exp(-2.57*tc[0]-717.162*Tinv);
      redP_save[34] = 1e-12 / k_f_save[34] * 2.2e+30*exp(-4.8*tc[0]-2798.19*Tinv);
      redP_save[37] = 1e-12 / k_f_save[37] * 1.2e+42*exp(-7.62*tc[0]-3507.8*Tinv);
      redP_save[38] = 1e-12 / k_f_save[38] * 1.99e+41*exp(-7.08*tc[0]-3364.37*Tinv);
      redP_save[40] = 1e-12 / k_f_save[40] * 5.07e+27*exp(-3.42*tc[0]-42450.9*Tinv);
      redP_save[74] = 1e-12 / k_f_save[74] * 1.77e+50*exp(-9.67*tc[0]-3130.35*Tinv);
    }
    ...
    phi_f = sc[1]*sc[7];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[29];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[29];
    ...
    phi_f = sc[1]*sc[9];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[30];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[30];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    phi_f = sc[1]*sc[13];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[32];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[32];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    redP = alpha * redP_save[34];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[34];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    phi_f = sc[1]*sc[16];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[37];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[37];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    phi_f = sc[1]*sc[17];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[38];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[38];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    phi_f = sc[0]*sc[11];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[40];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[40];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    phi_f = sc[9]*sc[9];
    alpha = mixture + sc[0] + 5*sc[5] + sc[10] + 0.5*sc[11] + sc[12] + 2*sc[18] + -0.3*sc[20];
    redP = alpha * redP_save[74];
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = logFcent_save[74];
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
