                      ...
                      const Geometry& geom)
{
    ...
    {
	std::cout << std::endl
		  << "JFG: in FluxRegister::Reflux" 
		  << std::endl;
	fr_print_values ("S at 1", icoord, jcoord, &S);
    }
    ...
    {
	std::cout << std::endl
		  << "JFG: entering FluxRegister::Reflux" 
		  << std::endl;
	fr_print_values ("S at 2", icoord, jcoord, &S);
    }
    std::vector<RF> RFs;
	...
	std::cout << std::endl
		  << "JFG: in FluxRegister::Reflux" 
		  << std::endl;
	fr_print_values ("S at 3", icoord, jcoord, &S);
    }
    fscd.CollectData();
    ...
    {
	std::cout << std::endl
		  << "JFG: leaving FluxRegister::Reflux" 
		  << std::endl;
	fr_print_values ("S at 4", icoord, jcoord, &S);
    }
}
