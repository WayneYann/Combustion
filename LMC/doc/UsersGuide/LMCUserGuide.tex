...
%\graphicspath{{LMCVerification/}{ConvertCheckpoint/}{Parallel/}{Scaling/}{Visualization/}}
...
\HRule\\[2mm]
\centering
{\Large \em An adaptive, parallel, hydrodynamics code for\\low Mach number chemically reacting flows}
...
\input Preface/LMCPreface

%-----------------------------------------------------------------------------
\part{Overview of the \lmc\ Algorithm}

\chapter{Introduction}
\input Introduction/LMCIntroduction

\chapter{Equation Set}
\input Equations/LMCEquations

%-----------------------------------------------------------------------------
\part{Using \lmc}

\chapter{Getting Started}
\input GettingStarted/LMCGettingStarted

%\chapter{Inputs Files}
%\input Inputs/LMCInputs.tex

\chapter{Units and Constants}
\input UnitsAndConstants/LMCUnits.tex

\chapter{Software Framework}
\input Software/LMCSoftware.tex
...
\input Visualization/LMCVisualization.tex

\chapter{Managing Jobs}\label{Chap:Managing}
