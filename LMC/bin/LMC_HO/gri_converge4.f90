...
1001 format(a,es9.2,a,f4.2,a,es9.2,a,f4.2,a,es9.2,a)
  ...
  write(*,1001) "$Y({\rm CH}_3)$          &",L1_10(14)," & ",log(L1_10(14)/L1_21(14))/log(2.d0)," &",L1_21(14)," & ", &
       log(L1_21(14)/L1_32(14))/log(2.d0)," &",L1_32(14)," \\"
  write(*,1001) "$Y({\rm CH}_2{\rm (S)})$ &",L1_10(13)," & ",log(L1_10(13)/L1_21(13))/log(2.d0)," &",L1_21(13)," & ", &
       log(L1_21(13)/L1_32(13))/log(2.d0)," &",L1_32(13)," \\"
  write(*,1001) "$Y({\rm O})$             &",L1_10( 4)," & ",log(L1_10( 4)/L1_21( 4))/log(2.d0)," &",L1_21( 4)," & ", &
       log(L1_21( 4)/L1_32( 4))/log(2.d0)," &",L1_32( 4)," \\"
  write(*,1001) "$Y({\rm H})$             &",L1_10( 3)," & ",log(L1_10( 3)/L1_21( 3))/log(2.d0)," &",L1_21( 3)," & ", &
