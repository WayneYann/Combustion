...
1001 format(a,es9.2,a,f4.2,a,es9.2,a,f4.2,a,es9.2,a)
  ...
  write(*,1001) "$Y({\rm CH}_2{\rm OH})$  &",L1_03(20)," & ",log(L1_03(20)/L1_13(20))/log(2.d0)," &",L1_13(20)," & ", &
       log(L1_13(20)/L1_23(20))/log(2.d0)," &",L1_23(20)," \\"
  write(*,1001) "$Y({\rm CH}_2{\rm H}_5)$ &",L1_03(27)," & ",log(L1_03(27)/L1_13(27))/log(2.d0)," &",L1_13(27)," & ", &
       log(L1_13(27)/L1_23(27))/log(2.d0)," &",L1_23(27)," \\"
