...
1001 format(a,es9.2,a,f4.2,a,es9.2,a,f4.2,a,es9.2,a)
  ...
  print*,""
  write(*,1001) "${\rm O}_2$        &",L1_03( 5)," & ",log(L1_03( 5)/L1_13( 5))/log(2.d0)," &",L1_13( 5)," & ", &
       log(L1_13( 5)/L1_23( 5))/log(2.d0)," &",L1_23( 5)," \\"
  write(*,1001) "${\rm H}_2{\rm O}$ &",L1_03( 7)," & ",log(L1_03( 7)/L1_13( 7))/log(2.d0)," &",L1_13( 7)," & ", &
       log(L1_13( 7)/L1_23( 7))/log(2.d0)," &",L1_23( 7)," \\"
  write(*,1001) "${\rm CH}_4$       &",L1_03(15)," & ",log(L1_03(15)/L1_13(15))/log(2.d0)," &",L1_13(15)," & ", &
       log(L1_13(15)/L1_23(15))/log(2.d0)," &",L1_23(15)," \\"
  write(*,1001) "${\rm CO}_2$       &",L1_03(17)," & ",log(L1_03(17)/L1_13(17))/log(2.d0)," &",L1_13(17)," & ", &
       log(L1_13(17)/L1_23(17))/log(2.d0)," &",L1_23(17)," \\"
  write(*,1001) "${\rm N}_2$        &",L1_03(49)," & ",log(L1_03(49)/L1_13(49))/log(2.d0)," &",L1_13(49)," & ", &
