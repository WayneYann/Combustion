...
ht.plot_ydot=0
ns.use_chemeq2=0
amr.derive_plot_vars=mag_vort rhoRT diveru avg_pressure gradpx gradpy gradpz mag_vort v_radial v_theta
#ns.verbose_vode = 1
#amr.restart=chk0060
# ------------------  INPUTS TO CLASS AMR ---------------------
# set up for bubble
...
amr.probin_file = probin.sw # This will default to file "probin" if not set
