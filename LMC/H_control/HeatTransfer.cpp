...
//     edgey_fab.close();
    ...
    */
    ...
    const int rho_corr = 1;
    // scalar_update calls scalar_advection_update and 
    // scalar_diffusion_update--why would we need to call this fn???
    // scalar_update(dt,Density,Density,rho_corr);
    //CEG:: the switch doesn't change anything
