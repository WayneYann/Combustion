...
C
C	this is CHEMKIN-III file xerror. V.3.1 November 1997;
C	it contains a set of public-domain error handler subroutines 
C       modified by Sandia for use by some of the programs and some
C       of the public-domain math subroutines.
C
C     Changes for v. 3.1: (E. Meeks)
C     1) Fix bug#117: Remove unused subroutine S88FMT that 
C        contained Hollerith values.
C
      SUBROUTINE FDUMP
