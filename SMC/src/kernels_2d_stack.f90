...
contains
  ...
  subroutine hypterm_2d (lo,hi,dx,cons,clo,chi,q,qlo,qhi,rhs_g,rlo,rhi,dlo_g,dhi_g,bclo,bchi)
    ...
    double precision :: tmpx(lo(1)-stencil_ng:hi(1)+stencil_ng), &
         tmpy(lo(1):hi(1), lo(2)-stencil_ng:hi(2)+stencil_ng)
    double precision :: rhs(lo(1):hi(1),lo(2):hi(2),ncons)
  ...
  subroutine diffterm_1(q,qlo,qhi,rhs,rlo,rhi,mu,xi, &
    ...
    double precision, dimension( lo(1): hi(1),dlo(2):dhi(2)) :: ux, vx
    double precision, dimension(dlo(1):dhi(1), lo(2): hi(2)) :: uy, vy
    double precision :: tmpx(dlo(1):dhi(1)), tmpy(lo(1):hi(1),dlo(2):dhi(2))
    double precision :: vsm(dlo(1):dhi(1),dlo(2):dhi(2))
  ...
  subroutine diffterm_2(q,qlo,qhi,rhs,rlo,rhi,mu,xi,lam,dxy0, &
    ...
    double precision, dimension(dlo(1):dhi(1),dlo(2):dhi(2)) :: vsp, dpe
    double precision, dimension(dlo(1):dhi(1),dlo(2):dhi(2),nspecies) :: dpy, dxe
    double precision :: Hg(lo(1):hi(1)+1,lo(2):hi(2)+1,2:ncons)
    ...
    double precision :: M8p(8,lo(1):hi(1)+1,lo(2):hi(2)+1)
    double precision, dimension(lo(1):hi(1),lo(2):hi(2)) :: sumdrY, sumrYv, gradp
