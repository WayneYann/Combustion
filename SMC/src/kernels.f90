          ...
          do j=lo(2),hi(2)
             ...
             do iface=0,1 
                ...
                do n = 1, nspecies
                   ...
                   Hcell(iface,iry1+n-1) = dot_product(dpy(i-2:i+1,j,k,n), M4p) &
          ...
          do i=lo(1),hi(1)
             do iface=0,1 
                ...
                do n = 1, nspecies
                   ...
                   Hcell(iface,iry1+n-1) = dot_product(dpy(i,j-2:j+1,k,n), M4p) &
          ...
          do i=lo(1),hi(1)
             do iface=0,1 
                ...
                do n = 1, nspecies
                   ...
                   Hcell(iface,iry1+n-1) = dot_product(dpy(i,j,k-2:k+1,n), M4p) &
