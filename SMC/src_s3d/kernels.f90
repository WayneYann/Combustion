...
contains
  ...
  subroutine chemterm_3d(lo,hi,q,qlo,qhi,up,uplo,uphi,upc,upclo,upchi,fd,flo,fhi,dt)
    ...
    double precision           :: fd (  flo(1):  fhi(1),  flo(2):  fhi(2),  flo(3):  fhi(3),ncons)
    
    integer :: iwrk, i,j,k,n, iryn
    ...
    do k=lo(3),hi(3)
       do j=lo(2),hi(2)
          do i=lo(1),hi(1)
             ...
             do n=1, nspecies
                iryn = iry1+n-1
                upc(i,j,k,iryn) = wdot(n) * molecular_weight(n)
                up (i,j,k,iryn) = up (i,j,k,iryn) + upc(i,j,k,iryn)
             end do
